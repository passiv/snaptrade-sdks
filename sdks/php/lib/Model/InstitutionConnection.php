...
/**
 * InstitutionConnection Class Doc Comment
 *
 * @category Class
 * @package  SnapTrade
 * @implements \ArrayAccess<string, mixed>
 */
class InstitutionConnection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Institution_connection';
    ...
    public const METHODS_OAUTH = 'OAUTH';
    public const METHODS_CREDENTIALS = 'CREDENTIALS';
    public const METHODS_API_KEY = 'API_KEY';
    public const SCOPES_READ = 'READ';
    public const SCOPES_TRADE = 'TRADE';
    ...
    public function getMethodsAllowableValues()
    {
        return [
            self::METHODS_OAUTH,
            self::METHODS_CREDENTIALS,
            self::METHODS_API_KEY,
        ];
    }
    ...
    */
     ...
     * Sets methods
     *
     * @param string[] $methods Ways an end user can connect. - `OAUTH`: the user signs in on the institution's own site and approves access. - `CREDENTIALS`: the user enters their login details in the SnapTrade Connection Portal. - `API_KEY`: the user creates an API key at the institution and pastes it in.
     *
     * @return self
     */
     ...
     * Sets scopes
     *
     * @param string[] $scopes What a connection can do. `READ` is always present. - `READ`: read accounts, balances, positions and activity. - `TRADE`: place orders.
     *
     * @return self
     */
