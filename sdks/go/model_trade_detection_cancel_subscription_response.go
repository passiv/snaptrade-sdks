...
func (o *TradeDetectionCancelSubscriptionResponse) UnmarshalJSON(bytes []byte) error {
	typedBytes := bytes
	decoded := _TradeDetectionCancelSubscriptionResponse{}
	...
	*o = TradeDetectionCancelSubscriptionResponse(decoded)
	return nil
}
