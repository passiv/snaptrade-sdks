...
func (o *AccountOrderRecordNullable) UnmarshalJSON(bytes []byte) error {
	typedBytes := bytes
	...
	for _, name := range []string{ "execution_price", "limit_price", "stop_price",  } {
		...
		if err := json.Unmarshal(raw, &number); err != nil {
			return fmt.Errorf("AccountOrderRecordNullable.%s: %w", name, err)
		}
	...
	decoded := _AccountOrderRecordNullable{}
	...
	*o = AccountOrderRecordNullable(decoded)
	return nil
}
