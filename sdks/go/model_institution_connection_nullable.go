...
// InstitutionConnectionNullable How end users connect to the institution and what the connection allows.
type InstitutionConnectionNullable struct {
...
type _InstitutionConnectionNullable InstitutionConnectionNullable
...
func NewInstitutionConnectionNullable(methods []string, scopes []string) *InstitutionConnectionNullable {
	this := InstitutionConnectionNullable{}
...
func (o InstitutionConnectionNullable) MarshalJSON() ([]byte, error) {
...
func (o *InstitutionConnectionNullable) UnmarshalJSON(bytes []byte) error {
	typedBytes := bytes
	decoded := _InstitutionConnectionNullable{}
	...
	*o = InstitutionConnectionNullable(decoded)
	return nil
}

type NullableInstitutionConnectionNullable struct {
	value *InstitutionConnectionNullable
	isSet bool
}

func (v NullableInstitutionConnectionNullable) Get() *InstitutionConnectionNullable {
	return v.value
}

func (v *NullableInstitutionConnectionNullable) Set(val *InstitutionConnectionNullable) {
	v.value = val
	v.isSet = true
}

func (v NullableInstitutionConnectionNullable) IsSet() bool {
	return v.isSet
}

func (v *NullableInstitutionConnectionNullable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstitutionConnectionNullable(val *InstitutionConnectionNullable) *NullableInstitutionConnectionNullable {
	return &NullableInstitutionConnectionNullable{value: val, isSet: true}
}

func (v NullableInstitutionConnectionNullable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstitutionConnectionNullable) UnmarshalJSON(src []byte) error {
	v.isSet = true
