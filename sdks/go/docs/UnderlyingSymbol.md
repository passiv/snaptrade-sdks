...
`func (o *UnderlyingSymbol) GetFigiInstrument() FigiInstrumentNullable`

GetFigiInstrument returns the FigiInstrument field if non-nil, zero value otherwise.

### GetFigiInstrumentOk

`func (o *UnderlyingSymbol) GetFigiInstrumentOk() (*FigiInstrumentNullable, bool)`
...
`func (o *UnderlyingSymbol) SetFigiInstrument(v FigiInstrumentNullable)`
