...
func main() {
    ...
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `ExperimentalEndpointsApi.GetAccountBalanceHistory``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", httpRes)
    }
    // response from `GetAccountBalanceHistory`: AccountValueHistoryResponse
    fmt.Fprintf(os.Stdout, "Response from `ExperimentalEndpointsApi.GetAccountBalanceHistory`: %v\n", resp)
...
func main() {
    ...
    fmt.Fprintf(os.Stdout, "Response from `AllAccountPositionsResponse.GetAllAccountPositions.Count`: %v\n", resp.Count)
    fmt.Fprintf(os.Stdout, "Response from `AllAccountPositionsResponse.GetAllAccountPositions.Next`: %v\n", resp.Next)
    fmt.Fprintf(os.Stdout, "Response from `AllAccountPositionsResponse.GetAllAccountPositions.Previous`: %v\n", resp.Previous)
