...
**CostBasis** | Pointer to **NullableFloat64** | Book price or average purchase price for the position. For options, this is per-share. | [optional] 
**Currency** | Pointer to **NullableString** | ISO-4217 currency code for the position &#x60;price&#x60; and &#x60;cost_basis&#x60;. | [optional] 
**CashEquivalent** | Pointer to **bool** | Present for mutual fund positions and for other instrument kinds when true. A true value means the position is also counted in cash balance or buying power. | [optional] 
