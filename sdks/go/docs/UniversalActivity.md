...
**Symbol** | Pointer to [**NullableSymbolNullable**](SymbolNullable.md) |  | [optional] 
**CurrencyUniversalSymbol** | Pointer to [**NullableSymbolNullable**](SymbolNullable.md) |  | [optional] 
...
`func (o *UniversalActivity) HasCurrencyUniversalSymbol() bool`

HasCurrencyUniversalSymbol returns a boolean if a field has been set.

### SetCurrencyUniversalSymbolNil

`func (o *UniversalActivity) SetCurrencyUniversalSymbolNil(b bool)`
...
`func (o *UniversalActivity) UnsetCurrencyUniversalSymbol()`
...
`func (o *UniversalActivity) SetCurrencyNil(b bool)`

 SetCurrencyNil sets the value for Currency to be an explicit nil

### UnsetCurrency
`func (o *UniversalActivity) UnsetCurrency()`
