...
type TradingApiGetOptionImpactRequest struct {
	ctx context.Context
	ApiService *TradingApiService
	userId string
	userSecret string
...
func (r TradingApiGetOptionImpactRequest) Execute() (*OptionImpact, *http.Response, error) {
	return r.ApiService.GetOptionImpactExecute(r)
}
...
Only supported for certain enabled brokerages. Please refer to the [brokerage trading support page](https://support.snaptrade.com/brokerages) for more information on which brokerages support this endpoint.
 ...
 @param accountId
 @param mlegTradeForm
 @return TradingApiGetOptionImpactRequest
*/
func (a *TradingApiService) GetOptionImpact(userId string, userSecret string, accountId string, mlegTradeForm MlegTradeForm) TradingApiGetOptionImpactRequest {
	return TradingApiGetOptionImpactRequest{
		ApiService: a,
		ctx: a.client.cfg.Context,
		userId: userId,
...
// Execute executes the request
//  @return OptionImpact
func (a *TradingApiService) GetOptionImpactExecute(r TradingApiGetOptionImpactRequest) (*OptionImpact, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *OptionImpact
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TradingApiService.GetOptionImpact")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

    subpath := "/accounts/{accountId}/trading/options/impact"
	localVarPath := localBasePath + subpath
	if a.client.cfg.Host != "" {
		localVarPath = a.client.cfg.Scheme + "://" + a.client.cfg.Host + subpath
	}
...
type TradingApiGetUserAccountOptionQuotesRequest struct {
	ctx context.Context
	ApiService *TradingApiService
	userId string
	userSecret string
...
func (r TradingApiGetUserAccountOptionQuotesRequest) Execute() (*OptionQuote, *http.Response, error) {
...
func (a *TradingApiService) GetUserAccountOptionQuotesExecute(r TradingApiGetUserAccountOptionQuotesRequest) (*OptionQuote, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TradingApiService.GetUserAccountOptionQuotes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type TradingApiPlaceComplexOrderRequest struct {
	ctx context.Context
	ApiService *TradingApiService
	accountId string
	userId string
	userSecret string
	manualTradeFormComplex ManualTradeFormComplex
}

func (r TradingApiPlaceComplexOrderRequest) Execute() (*ComplexOrderResponse, *http.Response, error) {
	return r.ApiService.PlaceComplexOrderExecute(r)
}
...
- **OTOCO** (One Triggers a One Cancels the Other): A trigger order that, when filled, activates an OCO pair of two peer orders.
 ...
 @param userId
 @param userSecret
 @param manualTradeFormComplex
 @return TradingApiPlaceComplexOrderRequest
*/
func (a *TradingApiService) PlaceComplexOrder(accountId string, userId string, userSecret string, manualTradeFormComplex ManualTradeFormComplex) TradingApiPlaceComplexOrderRequest {
	return TradingApiPlaceComplexOrderRequest{
		ApiService: a,
		ctx: a.client.cfg.Context,
		accountId: accountId,
...
func (a *TradingApiService) PlaceComplexOrderExecute(r TradingApiPlaceComplexOrderRequest) (*ComplexOrderResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ComplexOrderResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TradingApiService.PlaceComplexOrder")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

    subpath := "/accounts/{accountId}/trading/complex"
	localVarPath := localBasePath + subpath
	if a.client.cfg.Host != "" {
		localVarPath = a.client.cfg.Scheme + "://" + a.client.cfg.Host + subpath
	}
	...
	// body params
    if !checkNilInterface(r.manualTradeFormComplex) {
        localVarPostBody = r.manualTradeFormComplex
    }
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
...
type TradingApiSearchCryptocurrencyPairInstrumentsRequest struct {
	ctx context.Context
	ApiService *TradingApiService
	userId string
	userSecret string
...
Searches cryptocurrency pairs instruments accessible to the specified account. Both `base` and `quote` are optional. Omit both for a full list of cryptocurrency pairs.
 ...
 @param userSecret
 @param accountId
 @return TradingApiSearchCryptocurrencyPairInstrumentsRequest
*/
...
func (a *TradingApiService) SearchCryptocurrencyPairInstrumentsExecute(r TradingApiSearchCryptocurrencyPairInstrumentsRequest) (*TradingSearchCryptocurrencyPairInstruments200Response, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TradingApiService.SearchCryptocurrencyPairInstruments")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
