...
type _EtfInstrument EtfInstrument
...
func (v NullableEtfInstrument) Get() *EtfInstrument {
	return v.value
}

func (v *NullableEtfInstrument) Set(val *EtfInstrument) {
	v.value = val
	v.isSet = true
}

func (v NullableEtfInstrument) IsSet() bool {
	return v.isSet
}

func (v *NullableEtfInstrument) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEtfInstrument(val *EtfInstrument) *NullableEtfInstrument {
	return &NullableEtfInstrument{value: val, isSet: true}
}

func (v NullableEtfInstrument) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEtfInstrument) UnmarshalJSON(src []byte) error {
	v.isSet = true
