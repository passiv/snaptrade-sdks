...
If the connection has become disabled, it can no longer access the latest data from the brokerage, but will continue to return the last available cached state. Please see [this guide](/docs/fix-broken-connections) on how to fix a disabled connection.
 ...
 @param userSecret
 @param accountId
 @return ExperimentalEndpointsApiGetAllAccountPositionsRequest
*/
func (a *ExperimentalEndpointsApiService) GetAllAccountPositions(userId string, userSecret string, accountId string) ExperimentalEndpointsApiGetAllAccountPositionsRequest {
	return ExperimentalEndpointsApiGetAllAccountPositionsRequest{
		ApiService: a,
		ctx: a.client.cfg.Context,
		userId: userId,
...
func (a *ExperimentalEndpointsApiService) GetAllAccountPositionsExecute(r ExperimentalEndpointsApiGetAllAccountPositionsRequest) (*AllAccountPositionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentalEndpointsApiService.GetAllAccountPositions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ExperimentalEndpointsApiSyncBrokerageAuthorizationTransactionsRequest struct {
	ctx context.Context
	ApiService *ExperimentalEndpointsApiService
...
func (r ExperimentalEndpointsApiSyncBrokerageAuthorizationTransactionsRequest) Execute() (*BrokerageAuthorizationTransactionsSyncConfirmation, *http.Response, error) {
...
Trigger a transactions sync for all accounts under this connection. Updates will be queued asynchronously. Transactions are not updated intra-day, but calling this endpoint can ensure that the previous day's transactions have been synced. For more information on sync behaviour, see: https://docs.snaptrade.com/docs/syncing
 ...
 @param userId
 @param userSecret
 @return ExperimentalEndpointsApiSyncBrokerageAuthorizationTransactionsRequest
*/
func (a *ExperimentalEndpointsApiService) SyncBrokerageAuthorizationTransactions(authorizationId string, userId string, userSecret string) ExperimentalEndpointsApiSyncBrokerageAuthorizationTransactionsRequest {
	return ExperimentalEndpointsApiSyncBrokerageAuthorizationTransactionsRequest{
		ApiService: a,
		ctx: a.client.cfg.Context,
...
func (a *ExperimentalEndpointsApiService) SyncBrokerageAuthorizationTransactionsExecute(r ExperimentalEndpointsApiSyncBrokerageAuthorizationTransactionsRequest) (*BrokerageAuthorizationTransactionsSyncConfirmation, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentalEndpointsApiService.SyncBrokerageAuthorizationTransactions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
