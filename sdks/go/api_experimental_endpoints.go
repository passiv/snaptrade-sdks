...
func (r ExperimentalEndpointsApiListConnectionAccountsRequest) Execute() ([]ConnectionAccount, *http.Response, error) {
...
func (a *ExperimentalEndpointsApiService) ListConnectionAccountsExecute(r ExperimentalEndpointsApiListConnectionAccountsRequest) ([]ConnectionAccount, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentalEndpointsApiService.ListConnectionAccounts")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
