...
func (o *BrokerageAuthorizationTypeReadOnly) UnmarshalJSON(bytes []byte) error {
	typedBytes := bytes
	decoded := _BrokerageAuthorizationTypeReadOnly{}
	...
	*o = BrokerageAuthorizationTypeReadOnly(decoded)
	return nil
}
