...
type _AdrInstrument AdrInstrument
...
func (o *AdrInstrument) UnmarshalJSON(bytes []byte) (err error) {
	varAdrInstrument := _AdrInstrument{}

	if err = json.Unmarshal(bytes, &varAdrInstrument); err == nil {
		*o = AdrInstrument(varAdrInstrument)
	}
...
type NullableAdrInstrument struct {
	value *AdrInstrument
	isSet bool
}

func (v NullableAdrInstrument) Get() *AdrInstrument {
	return v.value
}

func (v *NullableAdrInstrument) Set(val *AdrInstrument) {
	v.value = val
	v.isSet = true
}

func (v NullableAdrInstrument) IsSet() bool {
	return v.isSet
}

func (v *NullableAdrInstrument) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdrInstrument(val *AdrInstrument) *NullableAdrInstrument {
	return &NullableAdrInstrument{value: val, isSet: true}
}

func (v NullableAdrInstrument) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdrInstrument) UnmarshalJSON(src []byte) error {
	v.isSet = true
