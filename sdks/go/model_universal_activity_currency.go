...
type UniversalActivityCurrency struct {
...
func NewUniversalActivityCurrency() *UniversalActivityCurrency {
	this := UniversalActivityCurrency{}
	return &this
}
...
func (o UniversalActivityCurrency) MarshalJSON() ([]byte, error) {
...
type NullableUniversalActivityCurrency struct {
	value *UniversalActivityCurrency
	isSet bool
}

func (v NullableUniversalActivityCurrency) Get() *UniversalActivityCurrency {
	return v.value
}

func (v *NullableUniversalActivityCurrency) Set(val *UniversalActivityCurrency) {
	v.value = val
	v.isSet = true
}

func (v NullableUniversalActivityCurrency) IsSet() bool {
	return v.isSet
}

func (v *NullableUniversalActivityCurrency) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniversalActivityCurrency(val *UniversalActivityCurrency) *NullableUniversalActivityCurrency {
	return &NullableUniversalActivityCurrency{value: val, isSet: true}
}

func (v NullableUniversalActivityCurrency) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniversalActivityCurrency) UnmarshalJSON(src []byte) error {
	v.isSet = true
