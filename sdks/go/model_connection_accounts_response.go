...
// ConnectionAccountsResponse Accounts under the specified connection.
type ConnectionAccountsResponse struct {
	// Accounts returned for the request.
	Results []ConnectionAccount `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _ConnectionAccountsResponse ConnectionAccountsResponse
...
func NewConnectionAccountsResponse(results []ConnectionAccount) *ConnectionAccountsResponse {
	this := ConnectionAccountsResponse{}
...
func (o ConnectionAccountsResponse) MarshalJSON() ([]byte, error) {
...
func (o *ConnectionAccountsResponse) UnmarshalJSON(bytes []byte) error {
	typedBytes := bytes
	decoded := _ConnectionAccountsResponse{}
	...
	*o = ConnectionAccountsResponse(decoded)
	return nil
}

type NullableConnectionAccountsResponse struct {
	value *ConnectionAccountsResponse
	isSet bool
}

func (v NullableConnectionAccountsResponse) Get() *ConnectionAccountsResponse {
	return v.value
}

func (v *NullableConnectionAccountsResponse) Set(val *ConnectionAccountsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectionAccountsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectionAccountsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectionAccountsResponse(val *ConnectionAccountsResponse) *NullableConnectionAccountsResponse {
	return &NullableConnectionAccountsResponse{value: val, isSet: true}
}

func (v NullableConnectionAccountsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectionAccountsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
