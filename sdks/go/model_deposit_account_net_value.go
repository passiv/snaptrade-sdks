...
type _DepositAccountNetValue DepositAccountNetValue
...
func (o *DepositAccountNetValue) SetAmountNil() {
	o.Amount.Set(nil)
}
...
func (o *DepositAccountNetValue) SetCurrencyNil() {
	o.Currency.Set(nil)
}
...
func (o DepositAccountNetValue) MarshalJSON() ([]byte, error) {
...
func (o *DepositAccountNetValue) UnmarshalJSON(bytes []byte) (err error) {
	varDepositAccountNetValue := _DepositAccountNetValue{}

	if err = json.Unmarshal(bytes, &varDepositAccountNetValue); err == nil {
		*o = DepositAccountNetValue(varDepositAccountNetValue)
	}
...
type NullableDepositAccountNetValue struct {
	value *DepositAccountNetValue
	isSet bool
}

func (v NullableDepositAccountNetValue) Get() *DepositAccountNetValue {
	return v.value
}

func (v *NullableDepositAccountNetValue) Set(val *DepositAccountNetValue) {
	v.value = val
	v.isSet = true
}

func (v NullableDepositAccountNetValue) IsSet() bool {
	return v.isSet
}

func (v *NullableDepositAccountNetValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDepositAccountNetValue(val *DepositAccountNetValue) *NullableDepositAccountNetValue {
	return &NullableDepositAccountNetValue{value: val, isSet: true}
}

func (v NullableDepositAccountNetValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDepositAccountNetValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
