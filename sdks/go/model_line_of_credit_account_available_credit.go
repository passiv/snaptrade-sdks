...
func (o *LineOfCreditAccountAvailableCredit) UnmarshalJSON(bytes []byte) error {
	typedBytes := bytes
	decoded := _LineOfCreditAccountAvailableCredit{}
	...
	*o = LineOfCreditAccountAvailableCredit(decoded)
	return nil
}
