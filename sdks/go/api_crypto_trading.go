...
type CryptoTradingApiGetCryptocurrencyPairQuoteRequest struct {
	ctx context.Context
...
func (r CryptoTradingApiGetCryptocurrencyPairQuoteRequest) Execute() (*CryptocurrencyPairQuote, *http.Response, error) {
...
Gets a quote for the specified account.
 ...
 @return CryptoTradingApiGetCryptocurrencyPairQuoteRequest
*/
func (a *CryptoTradingApiService) GetCryptocurrencyPairQuote(userId string, userSecret string, accountId string, instrumentSymbol string) CryptoTradingApiGetCryptocurrencyPairQuoteRequest {
	return CryptoTradingApiGetCryptocurrencyPairQuoteRequest{
		ApiService: a,
...
func (a *CryptoTradingApiService) GetCryptocurrencyPairQuoteExecute(r CryptoTradingApiGetCryptocurrencyPairQuoteRequest) (*CryptocurrencyPairQuote, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CryptoTradingApiService.GetCryptocurrencyPairQuote")
	if err != nil {
...
type CryptoTradingApiPlaceSimpleOrderRequest struct {
	ctx context.Context
	ApiService *CryptoTradingApiService
	userId string
	userSecret string
...
func (r CryptoTradingApiPlaceSimpleOrderRequest) Execute() (*OrderUpdatedResponse, *http.Response, error) {
	return r.ApiService.PlaceSimpleOrderExecute(r)
}

/*
PlaceSimpleOrder Place order v2
...
This endpoint does not compute the impact to the account balance from the order before submitting the order.
 ...
 @return CryptoTradingApiPlaceSimpleOrderRequest
*/
func (a *CryptoTradingApiService) PlaceSimpleOrder(userId string, userSecret string, accountId string, simpleOrderForm SimpleOrderForm) CryptoTradingApiPlaceSimpleOrderRequest {
	return CryptoTradingApiPlaceSimpleOrderRequest{
		ApiService: a,
		ctx: a.client.cfg.Context,
		userId: userId,
...
func (a *CryptoTradingApiService) PlaceSimpleOrderExecute(r CryptoTradingApiPlaceSimpleOrderRequest) (*OrderUpdatedResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CryptoTradingApiService.PlaceSimpleOrder")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
