...
|**amount** | [**BigDecimal**](BigDecimal.md) | The amount of the base currency to buy or sell. |  |
|**limitPrice** | [**BigDecimal**](BigDecimal.md) | The limit price. Required if the order type is LIMIT, STOP_LOSS_LIMIT or TAKE_PROFIT_LIMIT. |  [optional] |
|**stopPrice** | [**BigDecimal**](BigDecimal.md) | The stop price. Required if the order type is STOP_LOSS_MARKET, STOP_LOSS_LIMIT, TAKE_PROFIT_MARKET or TAKE_PROFIT_LIMIT. |  [optional] |
