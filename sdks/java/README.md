...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.54-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/5.0.54)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:5.0.54"
}
```
...
* `target/snaptrade-java-sdk-5.0.54.jar`
* `target/lib/*.jar`
