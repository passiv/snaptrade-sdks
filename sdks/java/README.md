...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.140-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/5.0.140)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:5.0.140"
}
```
...
* `target/snaptrade-java-sdk-5.0.140.jar`
* `target/lib/*.jar`
