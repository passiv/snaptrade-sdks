...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.160-blue)](https://central.sonatype.com/artifact/com.snaptrade/snaptrade-java-sdk/5.0.160)
...
dependencies {
   implementation "com.snaptrade:snaptrade-java-sdk:5.0.160"
}
```
...
* `target/snaptrade-java-sdk-5.0.160.jar`
* `target/lib/*.jar`
