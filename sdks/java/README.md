...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v4.12.0-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/4.12.0)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:4.12.0"
}
```
...
* `target/snaptrade-java-sdk-4.12.0.jar`
* `target/lib/*.jar`
