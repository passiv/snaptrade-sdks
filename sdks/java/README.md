...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.79-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/5.0.79)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:5.0.79"
}
```
...
* `target/snaptrade-java-sdk-5.0.79.jar`
* `target/lib/*.jar`
