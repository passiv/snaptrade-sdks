...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v4.11.1-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/4.11.1)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:4.11.1"
}
```
...
* `target/snaptrade-java-sdk-4.11.1.jar`
* `target/lib/*.jar`
