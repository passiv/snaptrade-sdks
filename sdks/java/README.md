...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v4.13.0-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/4.13.0)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:4.13.0"
}
```
...
* `target/snaptrade-java-sdk-4.13.0.jar`
* `target/lib/*.jar`
