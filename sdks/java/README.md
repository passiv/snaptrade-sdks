...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v6.0.3-blue)](https://central.sonatype.com/artifact/com.snaptrade/snaptrade-java-sdk/6.0.3)
...
dependencies {
   implementation "com.snaptrade:snaptrade-java-sdk:6.0.3"
}
```
...
* `target/snaptrade-java-sdk-6.0.3.jar`
* `target/lib/*.jar`
