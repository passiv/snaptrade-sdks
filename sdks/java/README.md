...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.1.0-blue)](https://central.sonatype.com/artifact/com.snaptrade/snaptrade-java-sdk/5.1.0)
...
dependencies {
   implementation "com.snaptrade:snaptrade-java-sdk:5.1.0"
}
```
...
* `target/snaptrade-java-sdk-5.1.0.jar`
* `target/lib/*.jar`
