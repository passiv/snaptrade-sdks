...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.7-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/5.0.7)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:5.0.7"
}
```
...
* `target/snaptrade-java-sdk-5.0.7.jar`
* `target/lib/*.jar`
