...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v6.0.4-blue)](https://central.sonatype.com/artifact/com.snaptrade/snaptrade-java-sdk/6.0.4)
...
dependencies {
   implementation "com.snaptrade:snaptrade-java-sdk:6.0.4"
}
```
...
* `target/snaptrade-java-sdk-6.0.4.jar`
* `target/lib/*.jar`
...
[UserAumPercentileResponse](./src/main/java/com/snaptrade/client/model/UserAumPercentileResponse.java)
