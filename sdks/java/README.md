...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.55-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/5.0.55)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:5.0.55"
}
```
...
* `target/snaptrade-java-sdk-5.0.55.jar`
* `target/lib/*.jar`
