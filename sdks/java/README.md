...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.106-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/5.0.106)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:5.0.106"
}
```
...
* `target/snaptrade-java-sdk-5.0.106.jar`
* `target/lib/*.jar`
