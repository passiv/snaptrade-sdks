...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v4.13.7-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/4.13.7)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:4.13.7"
}
```
...
* `target/snaptrade-java-sdk-4.13.7.jar`
* `target/lib/*.jar`
