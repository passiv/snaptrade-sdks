...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.175-blue)](https://central.sonatype.com/artifact/com.snaptrade/snaptrade-java-sdk/5.0.175)
...
dependencies {
   implementation "com.snaptrade:snaptrade-java-sdk:5.0.175"
}
```
...
* `target/snaptrade-java-sdk-5.0.175.jar`
* `target/lib/*.jar`
