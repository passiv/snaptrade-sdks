...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.51-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/5.0.51)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:5.0.51"
}
```
...
* `target/snaptrade-java-sdk-5.0.51.jar`
* `target/lib/*.jar`
