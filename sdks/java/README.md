...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.200-blue)](https://central.sonatype.com/artifact/com.snaptrade/snaptrade-java-sdk/5.0.200)
...
dependencies {
   implementation "com.snaptrade:snaptrade-java-sdk:5.0.200"
}
```
...
* `target/snaptrade-java-sdk-5.0.200.jar`
* `target/lib/*.jar`
