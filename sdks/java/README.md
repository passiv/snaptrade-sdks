...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.113-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/5.0.113)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:5.0.113"
}
```
...
* `target/snaptrade-java-sdk-5.0.113.jar`
* `target/lib/*.jar`
