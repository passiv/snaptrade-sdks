...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.196-blue)](https://central.sonatype.com/artifact/com.snaptrade/snaptrade-java-sdk/5.0.196)
...
dependencies {
   implementation "com.snaptrade:snaptrade-java-sdk:5.0.196"
}
```
...
* `target/snaptrade-java-sdk-5.0.196.jar`
* `target/lib/*.jar`
