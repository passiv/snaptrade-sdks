...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.168-blue)](https://central.sonatype.com/artifact/com.snaptrade/snaptrade-java-sdk/5.0.168)
...
* `target/snaptrade-java-sdk-5.0.168.jar`
* `target/lib/*.jar`
