...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v4.12.2-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/4.12.2)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:4.12.2"
}
```
...
* `target/snaptrade-java-sdk-4.12.2.jar`
* `target/lib/*.jar`
