...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.44-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/5.0.44)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:5.0.44"
}
```
...
* `target/snaptrade-java-sdk-5.0.44.jar`
* `target/lib/*.jar`
