...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v6.0.25-blue)](https://central.sonatype.com/artifact/com.snaptrade/snaptrade-java-sdk/6.0.25)
...
dependencies {
   implementation "com.snaptrade:snaptrade-java-sdk:6.0.25"
}
```
...
* `target/snaptrade-java-sdk-6.0.25.jar`
* `target/lib/*.jar`
...
[Institution](./src/main/java/com/snaptrade/client/model/Institution.java)
