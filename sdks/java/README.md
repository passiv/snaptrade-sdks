...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v5.0.46-blue)](https://central.sonatype.com/artifact/com.konfigthis/snaptrade-java-sdk/5.0.46)
...
dependencies {
   implementation "com.konfigthis:snaptrade-java-sdk:5.0.46"
}
```
...
* `target/snaptrade-java-sdk-5.0.46.jar`
* `target/lib/*.jar`
