...
import com.snaptrade.client.model.ManualTrade;
import com.snaptrade.client.model.ManualTradeBalance;
import com.snaptrade.client.model.ManualTradeImpact;
...
public class ManualTradeAndImpact {
  ...
  private List<ManualTradeImpact> tradeImpacts = null;
  ...
  **/
  ...
  public ManualTradeAndImpact tradeImpacts(List<ManualTradeImpact> tradeImpacts) {
  ...
  public ManualTradeAndImpact addTradeImpactsItem(ManualTradeImpact tradeImpactsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of impacts of the trade on the account. The list always contains one value at the moment.")

  public List<ManualTradeImpact> getTradeImpacts() {
    return tradeImpacts;
  }


  public void setTradeImpacts(List<ManualTradeImpact> tradeImpacts) {
      ...
      if (jsonObj.get("trade_impacts") != null && !jsonObj.get("trade_impacts").isJsonNull()) {
        ...
        if (jsonArraytradeImpacts != null) {
          ...
          for (int i = 0; i < jsonArraytradeImpacts.size(); i++) {
            ManualTradeImpact.validateJsonObject(jsonArraytradeImpacts.get(i).getAsJsonObject());
          };
        }
      }
