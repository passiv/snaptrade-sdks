...
import com.snaptrade.client.auth.Authentication;
import com.snaptrade.client.auth.HttpBasicAuth;
import com.snaptrade.client.auth.HttpBearerAuth;
import com.snaptrade.client.auth.ApiKeyAuth;
...
public class ApiClient extends ApiClientCustom {
    ...
    private void init() {
        ...
        setUserAgent("Konfig/5.0.156/java");
     ...
     * @return a {@link com.snaptrade.client.ApiClient} object
     */
     ...
     * @throws com.snaptrade.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.snaptrade.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.snaptrade.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.snaptrade.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.snaptrade.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.snaptrade.client.ApiException If fail to serialize the request body object
     */
     ...
     * @throws com.snaptrade.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.snaptrade.client.ApiException If fail to serialize the request body object into a string
     */
