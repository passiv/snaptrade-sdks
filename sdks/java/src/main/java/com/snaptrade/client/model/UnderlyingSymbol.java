...
import com.snaptrade.client.model.UnderlyingSymbolExchange;
import com.snaptrade.client.model.UnderlyingSymbolType;
 ...
 */
@ApiModel(description = "Symbol object for the underlying security of an option.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class UnderlyingSymbol {
  ...
  private UnderlyingSymbolExchange exchange;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SPY", value = "The security's trading ticker symbol. For example \"AAPL\" for Apple Inc. We largely follow the [Yahoo Finance ticker format](https://help.yahoo.com/kb/SLN2310.html)(click on \"Yahoo Finance Market Coverage and Data Delays\"). For example, for securities traded on the Toronto Stock Exchange, the symbol has a '.TO' suffix. For securities traded on NASDAQ or NYSE, the symbol does not have a suffix.")
  ...
  public UnderlyingSymbol rawSymbol(String rawSymbol) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "SPDR S&P 500 ETF Trust", value = "A human-readable description of the security. This is usually the company name or ETF name.")
  ...
  **/
  ...
  public UnderlyingSymbol exchange(UnderlyingSymbolExchange exchange) {
  ...
  **/
  ...
  public UnderlyingSymbolExchange getExchange() {
    return exchange;
  }


  public void setExchange(UnderlyingSymbolExchange exchange) {
  ...
  public UnderlyingSymbol type(UnderlyingSymbolType type) {
  ...
  **/
  ...
  public void setType(UnderlyingSymbolType type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, underlyingSymbol.id) &&
        ...
        Objects.equals(this.rawSymbol, underlyingSymbol.rawSymbol) &&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("exchange") != null && !jsonObj.get("exchange").isJsonNull()) {
        UnderlyingSymbolExchange.validateJsonObject(jsonObj.getAsJsonObject("exchange"));
      }
