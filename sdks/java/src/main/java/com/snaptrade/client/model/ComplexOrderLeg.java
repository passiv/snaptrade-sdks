 ...
 */
@ApiModel(description = "A single order within a complex group. For option OCOs, each peer trades one option contract type.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ComplexOrderLeg {
  ...
  **/
  ...
  public ComplexOrderLeg action(ActionStrictWithOptions action) {
  ...
  **/
  ...
  public ComplexOrderLeg units(Integer units) {
    if (units != null && units < 1) {
      throw new IllegalArgumentException("Invalid value for units. Must be greater than or equal to 1.");
    }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "1", required = true, value = "A positive whole number of shares or option contracts. Option OCO peers must use the same quantity.")
