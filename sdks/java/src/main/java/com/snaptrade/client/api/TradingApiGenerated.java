...
public class TradingApiGenerated {
    ...
    private okhttp3.Call getUserAccountOptionQuotesCall(String userId, String userSecret, UUID accountId, String symbol, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/accounts/{accountId}/quotes/options"
            .replace("{" + "accountId" + "}", localVarApiClient.escapeString(accountId.toString()));
    ...
    public TradingApi.GetUserAccountOptionQuotesRequestBuilder getUserAccountOptionQuotes(String userId, String userSecret, UUID accountId, String symbol) throws IllegalArgumentException {
        ...
        return ((TradingApi) this).new GetUserAccountOptionQuotesRequestBuilder(userId, userSecret, accountId, symbol);
    }
