...
import com.snaptrade.client.model.BalanceCurrency;
 ...
 */
@ApiModel(description = "Holds balance information for a single currency in an account.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Balance {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "410.71", value = "Buying power only applies to margin accounts. For non-margin accounts, buying power should be the same as cash. Please note that this field is not always available for all brokerages.")
