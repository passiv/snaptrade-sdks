 ...
 */
@ApiModel(description = "Contains information about the security that the order is for. This field is only present for stock/ETF/crypto/mutual fund orders. For option orders, this field will be null and the `option_symbol` field will be populated.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AccountOrderRecordUniversalSymbol {
  ...
  public AccountOrderRecordUniversalSymbol() {
  }

  public AccountOrderRecordUniversalSymbol id(UUID id) {
  ...
  **/
  ...
  public AccountOrderRecordUniversalSymbol symbol(String symbol) {
  ...
  **/
  ...
  public AccountOrderRecordUniversalSymbol rawSymbol(String rawSymbol) {
  ...
  **/
  ...
  public AccountOrderRecordUniversalSymbol description(String description) {
  ...
  **/
  ...
  public AccountOrderRecordUniversalSymbol currency(SymbolCurrency currency) {
  ...
  **/
  ...
  public AccountOrderRecordUniversalSymbol exchange(SymbolExchange exchange) {
  ...
  **/
  ...
  public AccountOrderRecordUniversalSymbol type(SecurityType type) {
  ...
  **/
  ...
  public AccountOrderRecordUniversalSymbol figiCode(String figiCode) {
  ...
  **/
  ...
  public AccountOrderRecordUniversalSymbol figiInstrument(FigiInstrumentNullable figiInstrument) {
  ...
  **/
  ...
  public AccountOrderRecordUniversalSymbol currencies(List<Currency> currencies) {
  ...
  public AccountOrderRecordUniversalSymbol addCurrenciesItem(Currency currenciesItem) {
  ...
  **/
   ...
   * @return the AccountOrderRecordUniversalSymbol instance itself
   */
  public AccountOrderRecordUniversalSymbol putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccountOrderRecordUniversalSymbol accountOrderRecordUniversalSymbol = (AccountOrderRecordUniversalSymbol) o;
    return Objects.equals(this.id, accountOrderRecordUniversalSymbol.id) &&
        Objects.equals(this.symbol, accountOrderRecordUniversalSymbol.symbol) &&
        Objects.equals(this.rawSymbol, accountOrderRecordUniversalSymbol.rawSymbol) &&
        Objects.equals(this.description, accountOrderRecordUniversalSymbol.description) &&
        Objects.equals(this.currency, accountOrderRecordUniversalSymbol.currency) &&
        Objects.equals(this.exchange, accountOrderRecordUniversalSymbol.exchange) &&
        Objects.equals(this.type, accountOrderRecordUniversalSymbol.type) &&
        Objects.equals(this.figiCode, accountOrderRecordUniversalSymbol.figiCode) &&
        Objects.equals(this.figiInstrument, accountOrderRecordUniversalSymbol.figiInstrument) &&
        Objects.equals(this.currencies, accountOrderRecordUniversalSymbol.currencies)&&
        Objects.equals(this.additionalProperties, accountOrderRecordUniversalSymbol.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountOrderRecordUniversalSymbol
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountOrderRecordUniversalSymbol.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountOrderRecordUniversalSymbol is not found in the empty JSON string", AccountOrderRecordUniversalSymbol.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountOrderRecordUniversalSymbol.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountOrderRecordUniversalSymbol.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountOrderRecordUniversalSymbol' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountOrderRecordUniversalSymbol> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountOrderRecordUniversalSymbol.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountOrderRecordUniversalSymbol>() {
           @Override
           public void write(JsonWriter out, AccountOrderRecordUniversalSymbol value) throws IOException {
           ...
           @Override
           public AccountOrderRecordUniversalSymbol read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountOrderRecordUniversalSymbol instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountOrderRecordUniversalSymbol given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountOrderRecordUniversalSymbol
  * @throws IOException if the JSON string is invalid with respect to AccountOrderRecordUniversalSymbol
  */
  public static AccountOrderRecordUniversalSymbol fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountOrderRecordUniversalSymbol.class);
  }

 /**
  * Convert an instance of AccountOrderRecordUniversalSymbol to an JSON string
  *
  * @return JSON string
  */
