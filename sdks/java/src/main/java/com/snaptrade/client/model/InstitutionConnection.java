...
public class InstitutionConnection {
 ...
 public enum ScopesEnum {
  ...
  public InstitutionConnection() {
  }

  public InstitutionConnection methods(List<MethodsEnum> methods) {
  ...
  public InstitutionConnection addMethodsItem(MethodsEnum methodsItem) {
  ...
  **/
  ...
  public InstitutionConnection scopes(List<ScopesEnum> scopes) {
  ...
  public InstitutionConnection addScopesItem(ScopesEnum scopesItem) {
  ...
  **/
   ...
   * @return the InstitutionConnection instance itself
   */
  public InstitutionConnection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InstitutionConnection institutionConnection = (InstitutionConnection) o;
    return Objects.equals(this.methods, institutionConnection.methods) &&
        Objects.equals(this.scopes, institutionConnection.scopes)&&
        Objects.equals(this.additionalProperties, institutionConnection.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InstitutionConnection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InstitutionConnection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstitutionConnection is not found in the empty JSON string", InstitutionConnection.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InstitutionConnection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstitutionConnection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstitutionConnection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstitutionConnection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstitutionConnection.class));

       return (TypeAdapter<T>) new TypeAdapter<InstitutionConnection>() {
           @Override
           public void write(JsonWriter out, InstitutionConnection value) throws IOException {
           ...
           @Override
           public InstitutionConnection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InstitutionConnection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InstitutionConnection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InstitutionConnection
  * @throws IOException if the JSON string is invalid with respect to InstitutionConnection
  */
  public static InstitutionConnection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstitutionConnection.class);
  }

 /**
  * Convert an instance of InstitutionConnection to an JSON string
  *
  * @return JSON string
  */
