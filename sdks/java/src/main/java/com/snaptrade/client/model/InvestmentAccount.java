 ...
 */
@ApiModel(description = "An investment account under a connection. `opening_date`, `funding_date`, and `net_value` are real-time or cached depending on the caller's plan -- see `Connections_listConnectionAccounts`. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class InvestmentAccount {
 ...
 public enum KindEnum {
  ...
  private InvestmentAccountNetValue netValue;
  ...
  **/
  ...
  @ApiModelProperty(example = "Robinhood Individual", value = "A display name for the account. Either assigned by the user or by the institution itself.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "54953432", value = "A stable and unique account identifier provided by the institution. Will be set to null if not provided. When present, can be used to check if a user has connected the same institution account across multiple connections.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "b6e1a9f0-6e2a-4c37-9b0a-6f1e2d3c4b5a", value = "Unique identifier for the institution that holds the account.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2024-07-20T09:30Z", value = "Timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format indicating when the account was opened at the institution. Only populated for institutions that expose this data; `null` for all other institutions. See [supported institutions](https://support.snaptrade.com/brokerages) for the full list.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Margin", value = "The account type as provided by the institution.")
  ...
  **/
  ...
  public InvestmentAccount netValue(InvestmentAccountNetValue netValue) {
  ...
  **/
  ...
  public InvestmentAccountNetValue getNetValue() {
    return netValue;
  }


  public void setNetValue(InvestmentAccountNetValue netValue) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("net_value") != null && !jsonObj.get("net_value").isJsonNull()) {
        InvestmentAccountNetValue.validateJsonObject(jsonObj.getAsJsonObject("net_value"));
      }
  }
