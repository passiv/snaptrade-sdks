 ...
 */
@ApiModel(description = "Accounts under the specified connection.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ConnectionAccountsResponse {
  public static final String SERIALIZED_NAME_RESULTS = "results";
  @SerializedName(SERIALIZED_NAME_RESULTS)
  private List<Object> results = new ArrayList<>();

  public ConnectionAccountsResponse() {
  }

  public ConnectionAccountsResponse results(List<Object> results) {
  ...
  public ConnectionAccountsResponse addResultsItem(Object resultsItem) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Accounts returned for the request.")
   ...
   * @return the ConnectionAccountsResponse instance itself
   */
  public ConnectionAccountsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConnectionAccountsResponse connectionAccountsResponse = (ConnectionAccountsResponse) o;
    return Objects.equals(this.results, connectionAccountsResponse.results)&&
        Objects.equals(this.additionalProperties, connectionAccountsResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectionAccountsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConnectionAccountsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConnectionAccountsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectionAccountsResponse is not found in the empty JSON string", ConnectionAccountsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConnectionAccountsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectionAccountsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectionAccountsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectionAccountsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectionAccountsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectionAccountsResponse>() {
           @Override
           public void write(JsonWriter out, ConnectionAccountsResponse value) throws IOException {
           ...
           @Override
           public ConnectionAccountsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConnectionAccountsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConnectionAccountsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConnectionAccountsResponse
  * @throws IOException if the JSON string is invalid with respect to ConnectionAccountsResponse
  */
  public static ConnectionAccountsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectionAccountsResponse.class);
  }

 /**
  * Convert an instance of ConnectionAccountsResponse to an JSON string
  *
  * @return JSON string
  */
