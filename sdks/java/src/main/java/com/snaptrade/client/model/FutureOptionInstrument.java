...
import com.snaptrade.client.model.FutureInstrument;
 ...
 */
@ApiModel(description = "Future option (option on a futures contract) instrument metadata for a V2 position.  **Beta:** currently returned only for tastytrade and Interactive Brokers connections, and only for partners it has been enabled for. This schema may change. ")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FutureOptionInstrument {
  /**
 ...
 public enum OptionTypeEnum {
  ...
  private FutureInstrument underlying;

  public FutureOptionInstrument() {
  }

  public FutureOptionInstrument kind(KindEnum kind) {
  ...
  **/
  ...
  @ApiModelProperty(example = "FUTURE_OPTION", required = true, value = "Type of security instrument.")
  ...
  public FutureOptionInstrument id(UUID id) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "5f1c9a76-2c1e-4bfb-9d18-3a2f0f5b6c41", required = true, value = "Unique identifier for the future option instrument.")
  ...
  public FutureOptionInstrument symbol(String symbol) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "ZBZ25 P105", required = true, value = "Display symbol for the future option contract.")
  ...
  public FutureOptionInstrument optionType(OptionTypeEnum optionType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "PUT", required = true, value = "Whether the contract is a call or put.")
  ...
  public FutureOptionInstrument strikePrice(BigDecimal strikePrice) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "105", required = true, value = "Strike price for the option contract.")
  ...
  public FutureOptionInstrument expirationDate(LocalDate expirationDate) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Fri Nov 21 00:00:00 UTC 2025", required = true, value = "Expiration date of the option contract.")
  ...
  public FutureOptionInstrument multiplier(BigDecimal multiplier) {
  ...
  **/
  ...
  @ApiModelProperty(example = "1000", value = "Notional multiplier for the option contract.")
  ...
  public FutureOptionInstrument description(String description) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "30 Year U.S. Treasury Bond Dec 2025 105 PUT", value = "Human-readable description of the option contract.")
  ...
  public FutureOptionInstrument currency(String currency) {
  ...
  **/
  ...
  public FutureOptionInstrument exchange(String exchange) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "XCBT", value = "Exchange MIC code or exchange code for the contract.")
  ...
  public FutureOptionInstrument underlying(FutureInstrument underlying) {
  ...
  **/
  ...
  public FutureInstrument getUnderlying() {
    return underlying;
  }


  public void setUnderlying(FutureInstrument underlying) {
   ...
   * @return the FutureOptionInstrument instance itself
   */
  public FutureOptionInstrument putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FutureOptionInstrument futureOptionInstrument = (FutureOptionInstrument) o;
    return Objects.equals(this.kind, futureOptionInstrument.kind) &&
        Objects.equals(this.id, futureOptionInstrument.id) &&
        Objects.equals(this.symbol, futureOptionInstrument.symbol) &&
        Objects.equals(this.optionType, futureOptionInstrument.optionType) &&
        Objects.equals(this.strikePrice, futureOptionInstrument.strikePrice) &&
        Objects.equals(this.expirationDate, futureOptionInstrument.expirationDate) &&
        Objects.equals(this.multiplier, futureOptionInstrument.multiplier) &&
        Objects.equals(this.description, futureOptionInstrument.description) &&
        Objects.equals(this.currency, futureOptionInstrument.currency) &&
        Objects.equals(this.exchange, futureOptionInstrument.exchange) &&
        Objects.equals(this.underlying, futureOptionInstrument.underlying)&&
        Objects.equals(this.additionalProperties, futureOptionInstrument.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(kind, id, symbol, optionType, strikePrice, expirationDate, multiplier, description, currency, exchange, underlying, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FutureOptionInstrument {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FutureOptionInstrument
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FutureOptionInstrument.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FutureOptionInstrument is not found in the empty JSON string", FutureOptionInstrument.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FutureOptionInstrument.openapiRequiredFields) {
      ...
      FutureInstrument.validateJsonObject(jsonObj.getAsJsonObject("underlying"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FutureOptionInstrument.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FutureOptionInstrument' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FutureOptionInstrument> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FutureOptionInstrument.class));

       return (TypeAdapter<T>) new TypeAdapter<FutureOptionInstrument>() {
           @Override
           public void write(JsonWriter out, FutureOptionInstrument value) throws IOException {
           ...
           @Override
           public FutureOptionInstrument read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FutureOptionInstrument instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FutureOptionInstrument given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FutureOptionInstrument
  * @throws IOException if the JSON string is invalid with respect to FutureOptionInstrument
  */
  public static FutureOptionInstrument fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FutureOptionInstrument.class);
  }

 /**
  * Convert an instance of FutureOptionInstrument to an JSON string
  *
  * @return JSON string
  */
