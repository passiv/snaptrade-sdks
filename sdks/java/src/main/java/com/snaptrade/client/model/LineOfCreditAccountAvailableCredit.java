 ...
 */
@ApiModel(description = "The remaining credit available to spend on the account (credit limit less the current balance). Omitted when no such data is available.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LineOfCreditAccountAvailableCredit {
  ...
  public LineOfCreditAccountAvailableCredit() {
  }

  public LineOfCreditAccountAvailableCredit amount(Double amount) {
  ...
  public LineOfCreditAccountAvailableCredit amount(Integer amount) {
  ...
  **/
  ...
  @ApiModelProperty(example = "4157.83", value = "")
  ...
  public LineOfCreditAccountAvailableCredit currency(String currency) {
  ...
  **/
   ...
   * @return the LineOfCreditAccountAvailableCredit instance itself
   */
  public LineOfCreditAccountAvailableCredit putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LineOfCreditAccountAvailableCredit lineOfCreditAccountAvailableCredit = (LineOfCreditAccountAvailableCredit) o;
    return Objects.equals(this.amount, lineOfCreditAccountAvailableCredit.amount) &&
        Objects.equals(this.currency, lineOfCreditAccountAvailableCredit.currency)&&
        Objects.equals(this.additionalProperties, lineOfCreditAccountAvailableCredit.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LineOfCreditAccountAvailableCredit {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LineOfCreditAccountAvailableCredit
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LineOfCreditAccountAvailableCredit.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LineOfCreditAccountAvailableCredit is not found in the empty JSON string", LineOfCreditAccountAvailableCredit.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LineOfCreditAccountAvailableCredit.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LineOfCreditAccountAvailableCredit' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LineOfCreditAccountAvailableCredit> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LineOfCreditAccountAvailableCredit.class));

       return (TypeAdapter<T>) new TypeAdapter<LineOfCreditAccountAvailableCredit>() {
           @Override
           public void write(JsonWriter out, LineOfCreditAccountAvailableCredit value) throws IOException {
           ...
           @Override
           public LineOfCreditAccountAvailableCredit read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LineOfCreditAccountAvailableCredit instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LineOfCreditAccountAvailableCredit given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LineOfCreditAccountAvailableCredit
  * @throws IOException if the JSON string is invalid with respect to LineOfCreditAccountAvailableCredit
  */
  public static LineOfCreditAccountAvailableCredit fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LineOfCreditAccountAvailableCredit.class);
  }

 /**
  * Convert an instance of LineOfCreditAccountAvailableCredit to an JSON string
  *
  * @return JSON string
  */
