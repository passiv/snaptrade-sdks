 ...
 */
@ApiModel(description = "Quote cryptocurrency. This field is only present for cryptocurrency pair orders with a cryptocurrency as quote.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AccountOrderRecordQuoteUniversalSymbol {
  ...
  public AccountOrderRecordQuoteUniversalSymbol id(UUID id) {
  ...
  **/
  ...
  public AccountOrderRecordQuoteUniversalSymbol symbol(String symbol) {
  ...
  **/
  ...
  public AccountOrderRecordQuoteUniversalSymbol rawSymbol(String rawSymbol) {
  ...
  **/
  ...
  public AccountOrderRecordQuoteUniversalSymbol description(String description) {
  ...
  **/
  ...
  public AccountOrderRecordQuoteUniversalSymbol currency(SymbolCurrency currency) {
  ...
  **/
  ...
  public AccountOrderRecordQuoteUniversalSymbol exchange(SymbolExchange exchange) {
  ...
  **/
  ...
  public AccountOrderRecordQuoteUniversalSymbol type(SecurityType type) {
  ...
  **/
  ...
  public AccountOrderRecordQuoteUniversalSymbol figiCode(String figiCode) {
  ...
  **/
  ...
  public AccountOrderRecordQuoteUniversalSymbol figiInstrument(FigiInstrumentNullable figiInstrument) {
  ...
  **/
  ...
  public AccountOrderRecordQuoteUniversalSymbol currencies(List<Currency> currencies) {
  ...
  public AccountOrderRecordQuoteUniversalSymbol addCurrenciesItem(Currency currenciesItem) {
  ...
  **/
   ...
   * @return the AccountOrderRecordQuoteUniversalSymbol instance itself
   */
  public AccountOrderRecordQuoteUniversalSymbol putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccountOrderRecordQuoteUniversalSymbol accountOrderRecordQuoteUniversalSymbol = (AccountOrderRecordQuoteUniversalSymbol) o;
    return Objects.equals(this.id, accountOrderRecordQuoteUniversalSymbol.id) &&
        Objects.equals(this.symbol, accountOrderRecordQuoteUniversalSymbol.symbol) &&
        Objects.equals(this.rawSymbol, accountOrderRecordQuoteUniversalSymbol.rawSymbol) &&
        Objects.equals(this.description, accountOrderRecordQuoteUniversalSymbol.description) &&
        Objects.equals(this.currency, accountOrderRecordQuoteUniversalSymbol.currency) &&
        Objects.equals(this.exchange, accountOrderRecordQuoteUniversalSymbol.exchange) &&
        Objects.equals(this.type, accountOrderRecordQuoteUniversalSymbol.type) &&
        Objects.equals(this.figiCode, accountOrderRecordQuoteUniversalSymbol.figiCode) &&
        Objects.equals(this.figiInstrument, accountOrderRecordQuoteUniversalSymbol.figiInstrument) &&
        Objects.equals(this.currencies, accountOrderRecordQuoteUniversalSymbol.currencies)&&
        Objects.equals(this.additionalProperties, accountOrderRecordQuoteUniversalSymbol.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountOrderRecordQuoteUniversalSymbol
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountOrderRecordQuoteUniversalSymbol.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountOrderRecordQuoteUniversalSymbol is not found in the empty JSON string", AccountOrderRecordQuoteUniversalSymbol.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountOrderRecordQuoteUniversalSymbol.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountOrderRecordQuoteUniversalSymbol.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountOrderRecordQuoteUniversalSymbol' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountOrderRecordQuoteUniversalSymbol> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountOrderRecordQuoteUniversalSymbol.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountOrderRecordQuoteUniversalSymbol>() {
           @Override
           public void write(JsonWriter out, AccountOrderRecordQuoteUniversalSymbol value) throws IOException {
           ...
           @Override
           public AccountOrderRecordQuoteUniversalSymbol read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountOrderRecordQuoteUniversalSymbol instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountOrderRecordQuoteUniversalSymbol given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountOrderRecordQuoteUniversalSymbol
  * @throws IOException if the JSON string is invalid with respect to AccountOrderRecordQuoteUniversalSymbol
  */
  public static AccountOrderRecordQuoteUniversalSymbol fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountOrderRecordQuoteUniversalSymbol.class);
  }

 /**
  * Convert an instance of AccountOrderRecordQuoteUniversalSymbol to an JSON string
  *
  * @return JSON string
  */
