 ...
 */
@ApiModel(description = "The option security for the transaction. The field is `null` if the transaction is not related to an option security (like a deposit, withdrawal, fee, etc). SnapTrade does a best effort to map the brokerage's option symbol. In cases where the brokerage option symbol is not recognized, the field will be set to `null`.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AccountUniversalActivityOptionSymbol {
 ...
 public enum OptionTypeEnum {
  ...
  public AccountUniversalActivityOptionSymbol id(UUID id) {
  ...
  **/
  ...
  public AccountUniversalActivityOptionSymbol ticker(String ticker) {
  ...
  **/
  ...
  public AccountUniversalActivityOptionSymbol optionType(OptionTypeEnum optionType) {
  ...
  **/
  ...
  public AccountUniversalActivityOptionSymbol strikePrice(Double strikePrice) {
  ...
  public AccountUniversalActivityOptionSymbol strikePrice(Integer strikePrice) {
  ...
  **/
  ...
  public AccountUniversalActivityOptionSymbol expirationDate(LocalDate expirationDate) {
  ...
  **/
  ...
  public AccountUniversalActivityOptionSymbol isMiniOption(Boolean isMiniOption) {
  ...
  **/
  ...
  public AccountUniversalActivityOptionSymbol underlyingSymbol(UnderlyingSymbol underlyingSymbol) {
  ...
  **/
   ...
   * @return the AccountUniversalActivityOptionSymbol instance itself
   */
  public AccountUniversalActivityOptionSymbol putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AccountUniversalActivityOptionSymbol accountUniversalActivityOptionSymbol = (AccountUniversalActivityOptionSymbol) o;
    return Objects.equals(this.id, accountUniversalActivityOptionSymbol.id) &&
        Objects.equals(this.ticker, accountUniversalActivityOptionSymbol.ticker) &&
        Objects.equals(this.optionType, accountUniversalActivityOptionSymbol.optionType) &&
        Objects.equals(this.strikePrice, accountUniversalActivityOptionSymbol.strikePrice) &&
        Objects.equals(this.expirationDate, accountUniversalActivityOptionSymbol.expirationDate) &&
        Objects.equals(this.isMiniOption, accountUniversalActivityOptionSymbol.isMiniOption) &&
        Objects.equals(this.underlyingSymbol, accountUniversalActivityOptionSymbol.underlyingSymbol)&&
        Objects.equals(this.additionalProperties, accountUniversalActivityOptionSymbol.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountUniversalActivityOptionSymbol
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountUniversalActivityOptionSymbol.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountUniversalActivityOptionSymbol is not found in the empty JSON string", AccountUniversalActivityOptionSymbol.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AccountUniversalActivityOptionSymbol.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountUniversalActivityOptionSymbol.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountUniversalActivityOptionSymbol' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountUniversalActivityOptionSymbol> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountUniversalActivityOptionSymbol.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountUniversalActivityOptionSymbol>() {
           @Override
           public void write(JsonWriter out, AccountUniversalActivityOptionSymbol value) throws IOException {
           ...
           @Override
           public AccountUniversalActivityOptionSymbol read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountUniversalActivityOptionSymbol instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountUniversalActivityOptionSymbol given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountUniversalActivityOptionSymbol
  * @throws IOException if the JSON string is invalid with respect to AccountUniversalActivityOptionSymbol
  */
  public static AccountUniversalActivityOptionSymbol fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountUniversalActivityOptionSymbol.class);
  }

 /**
  * Convert an instance of AccountUniversalActivityOptionSymbol to an JSON string
  *
  * @return JSON string
  */
