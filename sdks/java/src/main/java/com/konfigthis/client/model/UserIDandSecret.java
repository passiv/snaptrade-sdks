 ...
 */
@ApiModel(description = "Response when register user is successful")
...
public class UserIDandSecret {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "h81@cx1lkalablakwjaltkejraj11=", value = "SnapTrade User Secret randomly generated by Passiv.")
