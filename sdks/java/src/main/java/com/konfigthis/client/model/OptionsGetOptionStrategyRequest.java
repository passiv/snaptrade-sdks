...
public class OptionsGetOptionStrategyRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(underlyingSymbolId, legs, strategyType);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!OptionsGetOptionStrategyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OptionsGetOptionStrategyRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
