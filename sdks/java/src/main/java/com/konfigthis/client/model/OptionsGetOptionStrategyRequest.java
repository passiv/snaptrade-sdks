...
public class OptionsGetOptionStrategyRequest {
 ...
 public enum StrategyTypeEnum {
  ...
  public OptionsGetOptionStrategyRequest() {
  }
  ...
  **/
  ...
  public UUID getUnderlyingSymbolId() {
    return underlyingSymbolId;
  }
  ...
  public OptionsGetOptionStrategyRequest addLegsItem(OptionLeg legsItem) {
  ...
  **/
   ...
   * @return the OptionsGetOptionStrategyRequest instance itself
   */
  public OptionsGetOptionStrategyRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OptionsGetOptionStrategyRequest optionsGetOptionStrategyRequest = (OptionsGetOptionStrategyRequest) o;
    return Objects.equals(this.underlyingSymbolId, optionsGetOptionStrategyRequest.underlyingSymbolId) &&
        Objects.equals(this.legs, optionsGetOptionStrategyRequest.legs) &&
        Objects.equals(this.strategyType, optionsGetOptionStrategyRequest.strategyType)&&
        Objects.equals(this.additionalProperties, optionsGetOptionStrategyRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(underlyingSymbolId, legs, strategyType, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("underlying_symbol_id");
    openapiRequiredFields.add("legs");
    openapiRequiredFields.add("strategy_type");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OptionsGetOptionStrategyRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OptionsGetOptionStrategyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OptionsGetOptionStrategyRequest is not found in the empty JSON string", OptionsGetOptionStrategyRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OptionsGetOptionStrategyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OptionsGetOptionStrategyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OptionsGetOptionStrategyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OptionsGetOptionStrategyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OptionsGetOptionStrategyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OptionsGetOptionStrategyRequest>() {
           @Override
           public void write(JsonWriter out, OptionsGetOptionStrategyRequest value) throws IOException {
           ...
           @Override
           public OptionsGetOptionStrategyRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OptionsGetOptionStrategyRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OptionsGetOptionStrategyRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OptionsGetOptionStrategyRequest
  * @throws IOException if the JSON string is invalid with respect to OptionsGetOptionStrategyRequest
  */
  public static OptionsGetOptionStrategyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OptionsGetOptionStrategyRequest.class);
  }

 /**
  * Convert an instance of OptionsGetOptionStrategyRequest to an JSON string
  *
  * @return JSON string
  */
