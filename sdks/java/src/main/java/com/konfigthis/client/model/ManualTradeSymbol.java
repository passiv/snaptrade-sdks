 ...
 */
@ApiModel(description = "Information about the security for the order.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ManualTradeSymbol {
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1048101", value = "This field is deprecated and should not be used.")
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Metaverse Global ETF", value = "This field is deprecated and should not be used.")
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(example = "MVGP.U.TO", value = "This field is deprecated and should not be used.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.universalSymbolId, manualTradeSymbol.universalSymbolId) &&
        ...
        Objects.equals(this.brokerageSymbolId, manualTradeSymbol.brokerageSymbolId)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(universalSymbolId, currency, localId, description, symbol, brokerageSymbolId, additionalProperties);
  }
