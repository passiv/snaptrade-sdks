...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.Model400FailedRequestResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.Model401FailedRequestResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.Model403FailedRequestResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.Model404FailedRequestResponse.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.SnapTradeAcceptDisclaimerPostRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.SnapTradeLoginPost200Response.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.StrategyQuotesInner.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.SymbolsQuotes.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.konfigthis.client.model.TradeOcoPostRequest.CustomTypeAdapterFactory());
    ...
    public static String serialize(Object obj) {
        ...
        // CUSTOM CODE
        return serialized.equals("{}") || serialized.equals("") ? "" : serialized;
    }
