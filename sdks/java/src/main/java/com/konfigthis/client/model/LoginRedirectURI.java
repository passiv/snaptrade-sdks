 ...
 */
@ApiModel(description = "Redirect uri upon successful login")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LoginRedirectURI {
  ...
  **/
   ...
   * @return the LoginRedirectURI instance itself
   */
  public LoginRedirectURI putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoginRedirectURI
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoginRedirectURI.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoginRedirectURI' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoginRedirectURI> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoginRedirectURI.class));

       return (TypeAdapter<T>) new TypeAdapter<LoginRedirectURI>() {
           @Override
           public void write(JsonWriter out, LoginRedirectURI value) throws IOException {
           ...
           @Override
           public LoginRedirectURI read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoginRedirectURI instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoginRedirectURI given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoginRedirectURI
  * @throws IOException if the JSON string is invalid with respect to LoginRedirectURI
  */
  public static LoginRedirectURI fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoginRedirectURI.class);
  }

 /**
  * Convert an instance of LoginRedirectURI to an JSON string
  *
  * @return JSON string
  */
