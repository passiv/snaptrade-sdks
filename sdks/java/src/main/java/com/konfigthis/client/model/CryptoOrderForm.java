...
public class CryptoOrderForm {
 ...
 public enum TimeInForceEnum {
  ...
  public CryptoOrderForm() {
  }

  public CryptoOrderForm instrument(CryptoTradingInstrument instrument) {
  ...
  **/
  ...
  public CryptoTradingInstrument getInstrument() {
    return instrument;
  }


  public void setInstrument(CryptoTradingInstrument instrument) {
  ...
  public CryptoOrderForm side(ActionStrict side) {
  ...
  **/
  ...
  public CryptoOrderForm type(TypeEnum type) {
  ...
  **/
  ...
  public CryptoOrderForm timeInForce(TimeInForceEnum timeInForce) {
  ...
  **/
  ...
  public CryptoOrderForm amount(BigDecimal amount) {
  ...
  **/
  ...
  public CryptoOrderForm limitPrice(BigDecimal limitPrice) {
  ...
  **/
  ...
  public CryptoOrderForm stopPrice(BigDecimal stopPrice) {
  ...
  **/
  ...
  public CryptoOrderForm postOnly(Boolean postOnly) {
  ...
  **/
  ...
  public CryptoOrderForm expirationDate(OffsetDateTime expirationDate) {
  ...
  **/
   ...
   * @return the CryptoOrderForm instance itself
   */
  public CryptoOrderForm putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CryptoOrderForm cryptoOrderForm = (CryptoOrderForm) o;
    return Objects.equals(this.instrument, cryptoOrderForm.instrument) &&
        Objects.equals(this.side, cryptoOrderForm.side) &&
        Objects.equals(this.type, cryptoOrderForm.type) &&
        Objects.equals(this.timeInForce, cryptoOrderForm.timeInForce) &&
        Objects.equals(this.amount, cryptoOrderForm.amount) &&
        Objects.equals(this.limitPrice, cryptoOrderForm.limitPrice) &&
        Objects.equals(this.stopPrice, cryptoOrderForm.stopPrice) &&
        Objects.equals(this.postOnly, cryptoOrderForm.postOnly) &&
        Objects.equals(this.expirationDate, cryptoOrderForm.expirationDate)&&
        Objects.equals(this.additionalProperties, cryptoOrderForm.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CryptoOrderForm {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CryptoOrderForm
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CryptoOrderForm.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CryptoOrderForm is not found in the empty JSON string", CryptoOrderForm.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CryptoOrderForm.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `instrument`
      CryptoTradingInstrument.validateJsonObject(jsonObj.getAsJsonObject("instrument"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CryptoOrderForm.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CryptoOrderForm' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CryptoOrderForm> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CryptoOrderForm.class));

       return (TypeAdapter<T>) new TypeAdapter<CryptoOrderForm>() {
           @Override
           public void write(JsonWriter out, CryptoOrderForm value) throws IOException {
           ...
           @Override
           public CryptoOrderForm read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CryptoOrderForm instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CryptoOrderForm given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CryptoOrderForm
  * @throws IOException if the JSON string is invalid with respect to CryptoOrderForm
  */
  public static CryptoOrderForm fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CryptoOrderForm.class);
  }

 /**
  * Convert an instance of CryptoOrderForm to an JSON string
  *
  * @return JSON string
  */
