...
public class ManualTradeForm {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, action, orderType, price, stop, timeInForce, units, universalSymbolId);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ManualTradeForm.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ManualTradeForm` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
