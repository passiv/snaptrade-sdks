 ...
 */
@ApiModel(description = "A single brokerage account at a financial institution.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SnapTradeHoldingsAccountAccountId {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Alpaca", value = "The name of the financial institution that holds the account.")
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(example = "{\"type\":\"Margin\",\"status\":\"ACTIVE\",\"institution_name\":\"Alpaca\"}", value = "Additional information about the account, such as account type, status, etc. This information is specific to the financial institution and there's no standard format for this data. Please use at your own risk.")
  ...
  **/
  ...
  public SnapTradeHoldingsAccountAccountId createdDate(OffsetDateTime createdDate) {
