...
[![npm](https://img.shields.io/badge/gem-v3.0.25-blue)](https://rubygems.org/gems/snaptrade/versions/3.0.25)
...
```ruby
result = snaptrade.reference_data.list_institutions
p result
```

#### 🔄 Return<a id="🔄-return"></a>

[Institution](./lib/snaptrade/models/institution.rb)
