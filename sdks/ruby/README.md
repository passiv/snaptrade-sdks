...
[![npm](https://img.shields.io/badge/gem-v2.0.178-blue)](https://rubygems.org/gems/snaptrade/versions/2.0.178)
...
##### brokerage_authorizations: `String`<a id="brokerage_authorizations-string"></a>
Optional comma separated list of SnapTrade Connection
