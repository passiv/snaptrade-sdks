...
module SnapTrade
  ...
  class TradeExecutionStatus
    ...
    def valid?
      state_validator = EnumAttributeValidator.new('String', ["Executed", "Canceled", "Rejected", "Failed", "Not Executed"])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["Executed", "Canceled", "Rejected", "Failed", "Not Executed"])
