  ...
  class OptionStrategy
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SnapTrade::OptionStrategy` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SnapTrade::OptionStrategy`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'number_of_legs')
        self.number_of_legs = attributes[:'number_of_legs']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          number_of_legs == o.number_of_legs &&
          legs == o.legs
    end
    ...
    def hash
      [id, underlying_symbol_id, strategy_type, number_of_legs, legs].hash
    end
