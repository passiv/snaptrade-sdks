...
require 'snaptrade/models/cryptocurrency_market'
...
require 'snaptrade/models/trading_crypto_spot_quote_request'
require 'snaptrade/models/trading_crypto_spot_search_markets_request'
