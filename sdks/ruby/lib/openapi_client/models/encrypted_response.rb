...
module OpenapiClient
  ...
  class EncryptedResponse
    attr_accessor :encrypted_shared_key

    attr_accessor :encrypted_message_data
    ...
    def self.openapi_types
      {
        ...
        :'encrypted_message_data' => :'EncryptedResponseEncryptedMessageData'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::EncryptedResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::EncryptedResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'encrypted_shared_key')
        self.encrypted_shared_key = attributes[:'encrypted_shared_key']
      end

      if attributes.key?(:'encrypted_message_data')
        self.encrypted_message_data = attributes[:'encrypted_message_data']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          encrypted_shared_key == o.encrypted_shared_key &&
          encrypted_message_data == o.encrypted_message_data
    end
    ...
    def hash
      [encrypted_shared_key, encrypted_message_data].hash
    end
