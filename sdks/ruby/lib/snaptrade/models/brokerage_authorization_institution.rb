...
module SnapTrade
  class BrokerageAuthorizationInstitution
    ...
    def build_from_hash(value)
      return value if BrokerageAuthorizationInstitution.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #BrokerageAuthorizationInstitution"
    end
  end
end
