...
# Unit tests for OpenapiClient::StrategyImpactLegsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::StrategyImpactLegsInner do
  let(:instance) { OpenapiClient::StrategyImpactLegsInner.new }

  describe 'test an instance of StrategyImpactLegsInner' do
    it 'should create an instance of StrategyImpactLegsInner' do
      expect(instance).to be_instance_of(OpenapiClient::StrategyImpactLegsInner)
    end
  end
