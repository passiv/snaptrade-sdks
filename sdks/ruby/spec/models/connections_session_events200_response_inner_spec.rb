...
# Unit tests for OpenapiClient::ConnectionsSessionEvents200ResponseInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ConnectionsSessionEvents200ResponseInner do
  let(:instance) { OpenapiClient::ConnectionsSessionEvents200ResponseInner.new }
  ...
  describe 'test an instance of ConnectionsSessionEvents200ResponseInner' do
    it 'should create an instance of ConnectionsSessionEvents200ResponseInner' do
      expect(instance).to be_instance_of(OpenapiClient::ConnectionsSessionEvents200ResponseInner)
    end
  end
