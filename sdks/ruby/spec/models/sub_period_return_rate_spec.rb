...
# Unit tests for OpenapiClient::SubPeriodReturnRate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SubPeriodReturnRate do
  let(:instance) { OpenapiClient::SubPeriodReturnRate.new }

  describe 'test an instance of SubPeriodReturnRate' do
    it 'should create an instance of SubPeriodReturnRate' do
      expect(instance).to be_instance_of(OpenapiClient::SubPeriodReturnRate)
    end
  end
