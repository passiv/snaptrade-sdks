...
# Unit tests for SnapTrade::LineOfCreditAccountAvailableCredit
describe SnapTrade::LineOfCreditAccountAvailableCredit do
  let(:instance) { SnapTrade::LineOfCreditAccountAvailableCredit.new }

  describe 'test an instance of LineOfCreditAccountAvailableCredit' do
    it 'should create an instance of LineOfCreditAccountAvailableCredit' do
      expect(instance).to be_instance_of(SnapTrade::LineOfCreditAccountAvailableCredit)
    end
  end
