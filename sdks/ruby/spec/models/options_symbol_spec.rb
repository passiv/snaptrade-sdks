...
# Unit tests for SnapTrade::OptionsSymbol
describe SnapTrade::OptionsSymbol do
  let(:instance) { SnapTrade::OptionsSymbol.new }

  describe 'test an instance of OptionsSymbol' do
    it 'should create an instance of OptionsSymbol' do
      expect(instance).to be_instance_of(SnapTrade::OptionsSymbol)
    end
  end
