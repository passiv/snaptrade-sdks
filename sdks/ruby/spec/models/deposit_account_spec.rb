...
# Unit tests for SnapTrade::DepositAccount
describe SnapTrade::DepositAccount do
  let(:instance) { SnapTrade::DepositAccount.new }

  describe 'test an instance of DepositAccount' do
    it 'should create an instance of DepositAccount' do
      expect(instance).to be_instance_of(SnapTrade::DepositAccount)
    end
  end
