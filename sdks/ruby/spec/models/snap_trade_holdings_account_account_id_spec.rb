...
# Unit tests for OpenapiClient::SnapTradeHoldingsAccountAccountId
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SnapTradeHoldingsAccountAccountId do
  let(:instance) { OpenapiClient::SnapTradeHoldingsAccountAccountId.new }
  ...
  describe 'test an instance of SnapTradeHoldingsAccountAccountId' do
    it 'should create an instance of SnapTradeHoldingsAccountAccountId' do
      expect(instance).to be_instance_of(OpenapiClient::SnapTradeHoldingsAccountAccountId)
    end
  end
