...
# Unit tests for SnapTrade::StrategyOrderRecord
describe SnapTrade::StrategyOrderRecord do
  let(:instance) { SnapTrade::StrategyOrderRecord.new }

  describe 'test an instance of StrategyOrderRecord' do
    it 'should create an instance of StrategyOrderRecord' do
      expect(instance).to be_instance_of(SnapTrade::StrategyOrderRecord)
    end
  end
