...
# Unit tests for OpenapiClient::UniversalSymbolTicker
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UniversalSymbolTicker do
  let(:instance) { OpenapiClient::UniversalSymbolTicker.new }

  describe 'test an instance of UniversalSymbolTicker' do
    it 'should create an instance of UniversalSymbolTicker' do
      expect(instance).to be_instance_of(OpenapiClient::UniversalSymbolTicker)
    end
  end
