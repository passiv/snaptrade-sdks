...
# Unit tests for SnapTrade::AccountOrderRecord
describe SnapTrade::AccountOrderRecord do
  let(:instance) { SnapTrade::AccountOrderRecord.new }

  describe 'test an instance of AccountOrderRecord' do
    it 'should create an instance of AccountOrderRecord' do
      expect(instance).to be_instance_of(SnapTrade::AccountOrderRecord)
    end
  end
