...
# Unit tests for OpenapiClient::ModelPortfolioDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ModelPortfolioDetails do
  let(:instance) { OpenapiClient::ModelPortfolioDetails.new }

  describe 'test an instance of ModelPortfolioDetails' do
    it 'should create an instance of ModelPortfolioDetails' do
      expect(instance).to be_instance_of(OpenapiClient::ModelPortfolioDetails)
    end
  end
