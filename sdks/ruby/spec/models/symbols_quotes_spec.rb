...
# Unit tests for OpenapiClient::SymbolsQuotes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SymbolsQuotes do
  let(:instance) { OpenapiClient::SymbolsQuotes.new }

  describe 'test an instance of SymbolsQuotes' do
    it 'should create an instance of SymbolsQuotes' do
      expect(instance).to be_instance_of(OpenapiClient::SymbolsQuotes)
    end
  end
