...
# Unit tests for OpenapiClient::ModelPortfolio
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ModelPortfolio do
  let(:instance) { OpenapiClient::ModelPortfolio.new }

  describe 'test an instance of ModelPortfolio' do
    it 'should create an instance of ModelPortfolio' do
      expect(instance).to be_instance_of(OpenapiClient::ModelPortfolio)
    end
  end
