...
# Unit tests for SnapTrade::UniversalActivity
describe SnapTrade::UniversalActivity do
  let(:instance) { SnapTrade::UniversalActivity.new }

  describe 'test an instance of UniversalActivity' do
    it 'should create an instance of UniversalActivity' do
      expect(instance).to be_instance_of(SnapTrade::UniversalActivity)
    end
  end
