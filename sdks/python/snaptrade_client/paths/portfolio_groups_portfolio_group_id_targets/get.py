...
class BaseApi(api_client.Api):
    ...
    def _get_portfolio_targets_mapped_args(
        self,
    ...
    async def _aget_portfolio_targets_oapg(
        self,
        path_params: typing.Optional[dict] = {},
    ...
    def _get_portfolio_targets_oapg(
        self,
        path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class GetPortfolioTargets(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_portfolio_targets(
        self,
        portfolio_group_id: typing.Optional[str] = None,
        path_params: typing.Optional[dict] = {},
    ) -> typing.Union[
        ...
        args = self._get_portfolio_targets_mapped_args(
            path_params=path_params,
            portfolio_group_id=portfolio_group_id,
        )
        return await self._aget_portfolio_targets_oapg(
    ...
    def get_portfolio_targets(
        ...
        return self._get_portfolio_targets_oapg(
            path_params=args.path,
        )
