...
from snaptrade_client.model.delete_connection_confirmation import DeleteConnectionConfirmation as DeleteConnectionConfirmationSchema

from snaptrade_client.type.delete_connection_confirmation import DeleteConnectionConfirmation
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'connectionId': typing.Union[ConnectionIdSchema, str, uuid.UUID, ],
    }
)
...
_auth = None
SchemaFor200ResponseBodyApplicationJson = DeleteConnectionConfirmationSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DeleteConnectionConfirmation
...
class BaseApi(api_client.Api):
    ...
    def _delete_connection_mapped_args(
        self,
    ...
    async def _adelete_connection_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        header_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/connection/{connectionId}',
            auth_settings=_auth,
...
class DeleteConnection(BaseApi, typing.Generic[TAuth]):
    ...
    async def adelete_connection(
        ...
        **kwargs,
        ...
        args = self._delete_connection_mapped_args(
            path_params=path_params,
            connection_id=connection_id,
            user_id=user_id,
            user_secret=user_secret,
        )
        return await self._adelete_connection_oapg(
...
class ApiFordelete(BaseApi, typing.Generic[TAuth]):
