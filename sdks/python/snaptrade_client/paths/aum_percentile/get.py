...
from snaptrade_client.model.user_aum_percentile_response import UserAumPercentileResponse as UserAumPercentileResponseSchema
...
from snaptrade_client.type.user_aum_percentile_response import UserAumPercentileResponse
...
_auth = None
SchemaFor200ResponseBodyApplicationJson = UserAumPercentileResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UserAumPercentileResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_user_aum_percentile_mapped_args(
        self,
    ...
    async def _aget_user_aum_percentile_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        header_params: typing.Optional[dict] = {},
    ...
    def _get_user_aum_percentile_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetUserAumPercentile(BaseApi, typing.Generic[TAuth]):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_aum_percentile(
        self,
        user_id: typing.Optional[str] = None,
        user_secret: typing.Optional[str] = None,
        query_params: typing.Optional[dict] = {},
        ...
        **kwargs,
        ...
        args = self._get_user_aum_percentile_mapped_args(
            user_id=user_id,
            user_secret=user_secret,
        )
        return await self._aget_user_aum_percentile_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def get_user_aum_percentile(
        self,
        user_id: typing.Optional[str] = None,
        user_secret: typing.Optional[str] = None,
        query_params: typing.Optional[dict] = {},
        ...
        return self._get_user_aum_percentile_oapg(
            query_params=args.query,
            header_params=args.header,
        )
