...
from snaptrade_client.model.account_value_history_response import AccountValueHistoryResponse as AccountValueHistoryResponseSchema
...
from snaptrade_client.type.account_value_history_response import AccountValueHistoryResponse
...
_auth = None
SchemaFor200ResponseBodyApplicationJson = AccountValueHistoryResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AccountValueHistoryResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_account_balance_history_mapped_args(
        self,
    ...
    async def _aget_account_balance_history_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        header_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/accounts/{accountId}/balanceHistory',
            auth_settings=_auth,
    ...
    def _get_account_balance_history_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        header_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
...
class GetAccountBalanceHistory(BaseApi, typing.Generic[TAuth]):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_account_balance_history(
        self,
        account_id: typing.Optional[str] = None,
        user_id: typing.Optional[str] = None,
        user_secret: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        return await self._aget_account_balance_history_oapg(
    ...
    def get_account_balance_history(
        ...
        return self._get_account_balance_history_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )
