...
class GetUserAccountOrdersV2(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def get_user_account_orders_v2(
        self: "GetUserAccountOrdersV2[CommercialApiKeyAuth]",
        account_id: str,
        user_id: str,
        user_secret: str,
    ...
    @typing.overload
    def get_user_account_orders_v2(
        self: "GetUserAccountOrdersV2[PersonalApiKeyAuth]",
        account_id: str,
        state: typing.Optional[str] = None,
        days: typing.Optional[int] = None,
...
class ApiForget(GetUserAccountOrdersV2[TAuth]):
    @typing.overload
    def get(
