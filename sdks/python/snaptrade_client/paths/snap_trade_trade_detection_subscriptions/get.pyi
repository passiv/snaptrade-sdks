...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['TradeDetectionSubscriptionSchema']:
            return TradeDetectionSubscriptionSchema

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['TradeDetectionSubscription'], typing.List['TradeDetectionSubscription']],
    ...
    def __getitem__(self, i: int) -> 'TradeDetectionSubscription':
        return super().__getitem__(i)


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: typing.List[TradeDetectionSubscription]
