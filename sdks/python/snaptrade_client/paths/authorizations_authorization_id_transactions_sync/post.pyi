...
class SyncBrokerageAuthorizationTransactions(BaseApi, typing.Generic[TAuth]):
    ...
    def sync_brokerage_authorization_transactions(
        self: "SyncBrokerageAuthorizationTransactions[CommercialApiKeyAuth]",
    ...
    @typing.overload
    def sync_brokerage_authorization_transactions(
        self: "SyncBrokerageAuthorizationTransactions[PersonalApiKeyAuth]",
        authorization_id: str,
...
class ApiForpost(SyncBrokerageAuthorizationTransactions[TAuth]):
    @typing.overload
    def post(
