...
class GetUserAccountOptionQuotes(BaseApi, typing.Generic[TAuth]):
    ...
    def get_user_account_option_quotes(
        self: "GetUserAccountOptionQuotes[CommercialApiKeyAuth]",
        account_id: str,
        symbol: str,
        user_id: str,
        user_secret: str,
    ...
    @typing.overload
    def get_user_account_option_quotes(
        self: "GetUserAccountOptionQuotes[PersonalApiKeyAuth]",
        account_id: str,
        symbol: str,
...
class ApiForget(GetUserAccountOptionQuotes[TAuth]):
    @typing.overload
    def get(
