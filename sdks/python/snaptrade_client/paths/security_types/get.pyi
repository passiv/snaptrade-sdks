...
class GetSecurityTypes(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def get_security_types(
        self: "GetSecurityTypes[CommercialApiKeyAuth]",
        validate: bool = ...,
    ) -> typing.Any: ...
    @typing.overload
    def get_security_types(
        self: "GetSecurityTypes[PersonalApiKeyAuth]",
        validate: bool = ...,
    ) -> typing.Any: ...


class ApiForget(GetSecurityTypes[TAuth]):
    @typing.overload
    def get(
