...
class ListAllBrokerages(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def list_all_brokerages(
        self: "ListAllBrokerages[CommercialApiKeyAuth]",
        validate: bool = ...,
    ) -> typing.Any: ...
    @typing.overload
    def list_all_brokerages(
        self: "ListAllBrokerages[PersonalApiKeyAuth]",
        validate: bool = ...,
    ) -> typing.Any: ...


class ApiForget(ListAllBrokerages[TAuth]):
    @typing.overload
    def get(
