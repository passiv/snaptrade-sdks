...
class UpdateUserAccount(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def update_user_account(
        self: "UpdateUserAccount[CommercialApiKeyAuth]",
        account_id: str,
        user_id: str,
        user_secret: str,
    ...
    @typing.overload
    def update_user_account(
        self: "UpdateUserAccount[PersonalApiKeyAuth]",
        account_id: str,
...
class ApiForput(UpdateUserAccount[TAuth]):
    @typing.overload
    def put(
        self: "ApiForput[CommercialApiKeyAuth]",
        account_id: str,
        user_id: str,
        user_secret: str,
        query_params: typing.Optional[dict] = ...,
    ...
    @typing.overload
    def put(
        self: "ApiForput[PersonalApiKeyAuth]",
        account_id: str,
        user_id: typing.Optional[typing_extensions.Never] = None,
        user_secret: typing.Optional[typing_extensions.Never] = None,
        query_params: typing.Optional[dict] = ...,
