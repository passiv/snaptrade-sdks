...
class ListAllCurrenciesRates(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def list_all_currencies_rates(
        self: "ListAllCurrenciesRates[CommercialApiKeyAuth]",
        validate: bool = ...,
    ) -> typing.Any: ...
    @typing.overload
    def list_all_currencies_rates(
        self: "ListAllCurrenciesRates[PersonalApiKeyAuth]",
        validate: bool = ...,
    ) -> typing.Any: ...


class ApiForget(ListAllCurrenciesRates[TAuth]):
    @typing.overload
    def get(
