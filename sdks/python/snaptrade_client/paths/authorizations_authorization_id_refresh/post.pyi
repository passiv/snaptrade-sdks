...
class RefreshBrokerageAuthorization(BaseApi, typing.Generic[TAuth]):
    ...
    def refresh_brokerage_authorization(
        self: "RefreshBrokerageAuthorization[CommercialApiKeyAuth]",
    ...
    @typing.overload
    def refresh_brokerage_authorization(
        self: "RefreshBrokerageAuthorization[PersonalApiKeyAuth]",
        authorization_id: str,
...
class ApiForpost(RefreshBrokerageAuthorization[TAuth]):
    @typing.overload
    def post(
