...
class BaseApi(api_client.Api):
    ...
    def _crypto_spot_cancel_order_mapped_args(
        self,
    ...
    async def _acrypto_spot_cancel_order_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/accounts/{accountId}/trading/crypto/spot/cancelOrder',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _crypto_spot_cancel_order_oapg(
        self,
        body: typing.Any = None,
        query_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
...
class CryptoSpotCancelOrder(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acrypto_spot_cancel_order(
        self,
        body: typing.Optional[typing.Any] = None,
        brokerage_order_id: typing.Optional[str] = None,
        user_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._crypto_spot_cancel_order_mapped_args(
            body=body,
        ...
        return await self._acrypto_spot_cancel_order_oapg(
            body=args.body,
    ...
    def crypto_spot_cancel_order(
        ...
        return self._crypto_spot_cancel_order_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )
