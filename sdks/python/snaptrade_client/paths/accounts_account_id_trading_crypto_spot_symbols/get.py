...
class BaseApi(api_client.Api):
    ...
    def _crypto_spot_symbols_mapped_args(
        self,
    ...
    async def _acrypto_spot_symbols_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/accounts/{accountId}/trading/crypto/spot/symbols',
            auth_settings=_auth,
            headers=_headers,
        )
...
class CryptoSpotSymbols(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acrypto_spot_symbols(
        self,
        user_id: typing.Optional[str] = None,
        user_secret: typing.Optional[str] = None,
        account_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._crypto_spot_symbols_mapped_args(
        ...
        return await self._acrypto_spot_symbols_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def crypto_spot_symbols(
        self,
        user_id: typing.Optional[str] = None,
        user_secret: typing.Optional[str] = None,
        account_id: typing.Optional[str] = None,
        ...
        return self._crypto_spot_symbols_oapg(
            query_params=args.query,
            path_params=args.path,
        )
