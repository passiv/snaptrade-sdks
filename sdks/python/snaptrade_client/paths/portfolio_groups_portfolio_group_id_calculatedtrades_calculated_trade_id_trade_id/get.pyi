...
class BaseApi(api_client.Api):
    ...
    def _get_calculated_trade_by_id_mapped_args(
        self,
    ...
    async def _aget_calculated_trade_by_id_oapg(
        self,
        path_params: typing.Optional[dict] = {},
    ...
    def _get_calculated_trade_by_id_oapg(
        self,
        path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class GetCalculatedTradeById(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_calculated_trade_by_id(
        self,
        portfolio_group_id: typing.Optional[str] = None,
        calculated_trade_id: typing.Optional[str] = None,
        trade_id: typing.Optional[str] = None,
        ...
        args = self._get_calculated_trade_by_id_mapped_args(
            path_params=path_params,
            portfolio_group_id=portfolio_group_id,
            calculated_trade_id=calculated_trade_id,
            trade_id=trade_id,
        )
        return await self._aget_calculated_trade_by_id_oapg(
    ...
    def get_calculated_trade_by_id(
        ...
        return self._get_calculated_trade_by_id_oapg(
            path_params=args.path,
        )
