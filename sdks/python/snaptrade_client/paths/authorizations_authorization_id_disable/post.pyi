...
from snaptrade_client.model.brokerage_authorization_disabled_confirmation import BrokerageAuthorizationDisabledConfirmation as BrokerageAuthorizationDisabledConfirmationSchema
...
from snaptrade_client.model.model402_brokerage_auth_already_disabled_exception import Model402BrokerageAuthAlreadyDisabledException as Model402BrokerageAuthAlreadyDisabledExceptionSchema
...
from snaptrade_client.type.brokerage_authorization_disabled_confirmation import BrokerageAuthorizationDisabledConfirmation
from snaptrade_client.type.model402_brokerage_auth_already_disabled_exception import Model402BrokerageAuthAlreadyDisabledException
...
SchemaFor200ResponseBodyApplicationJson = BrokerageAuthorizationDisabledConfirmationSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BrokerageAuthorizationDisabledConfirmation
...
SchemaFor402ResponseBodyApplicationJson = Model402BrokerageAuthAlreadyDisabledExceptionSchema


@dataclass
class ApiResponseFor402(api_client.ApiResponse):
    body: Model402BrokerageAuthAlreadyDisabledException
...
class BaseApi(api_client.Api):
    ...
    def _disable_brokerage_authorization_mapped_args(
        self,
    ...
    async def _adisable_brokerage_authorization_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/authorizations/{authorizationId}/disable',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _disable_brokerage_authorization_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DisableBrokerageAuthorization(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adisable_brokerage_authorization(
        self,
        authorization_id: typing.Optional[str] = None,
        user_id: typing.Optional[str] = None,
        user_secret: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._disable_brokerage_authorization_mapped_args(
        ...
        return await self._adisable_brokerage_authorization_oapg(
    ...
    def disable_brokerage_authorization(
        ...
        return self._disable_brokerage_authorization_oapg(
            query_params=args.query,
            path_params=args.path,
        )
