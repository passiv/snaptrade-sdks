...
class GetUserAccountRecentOrders(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def get_user_account_recent_orders(
        self: "GetUserAccountRecentOrders[CommercialApiKeyAuth]",
        account_id: str,
        user_id: str,
        user_secret: str,
    ...
    @typing.overload
    def get_user_account_recent_orders(
        self: "GetUserAccountRecentOrders[PersonalApiKeyAuth]",
        account_id: str,
        only_executed: typing.Optional[bool] = None,
...
class ApiForget(GetUserAccountRecentOrders[TAuth]):
    @typing.overload
    def get(
