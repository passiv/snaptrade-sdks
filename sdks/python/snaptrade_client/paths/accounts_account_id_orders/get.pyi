...
class GetUserAccountOrders(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def get_user_account_orders(
        self: "GetUserAccountOrders[CommercialApiKeyAuth]",
        account_id: str,
        user_id: str,
        user_secret: str,
    ...
    @typing.overload
    def get_user_account_orders(
        self: "GetUserAccountOrders[PersonalApiKeyAuth]",
        account_id: str,
        state: typing.Optional[str] = None,
        days: typing.Optional[int] = None,
...
class ApiForget(GetUserAccountOrders[TAuth]):
    @typing.overload
    def get(
