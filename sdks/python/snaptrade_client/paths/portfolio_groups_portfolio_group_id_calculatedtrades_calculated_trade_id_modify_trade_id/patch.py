...
class ModifyCalculatedTradeById(BaseApi):
    ...
    def modify_calculated_trade_by_id(
        ...
        calculated_trade_id: typing.Any = None,
        trade_id: typing.Any = None,
        id: typing.Any = None,
        account: typing.Any = None,
        symbol: typing.Any = None,
        universal_symbol: typing.Any = None,
        action: typing.Any = None,
        units: typing.Any = None,
        price: typing.Any = None,
        sequence: typing.Any = None,
        path_params: typing.Union[RequestPathParams, dict] = {},
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        if isinstance(body, dict) and id is not None:
            body["id"] = id
        if isinstance(body, dict) and account is not None:
            body["account"] = account
        if isinstance(body, dict) and symbol is not None:
            body["symbol"] = symbol
        if isinstance(body, dict) and universal_symbol is not None:
            body["universal_symbol"] = universal_symbol
        ...
        if isinstance(body, dict) and price is not None:
            body["price"] = price
        if isinstance(body, dict) and sequence is not None:
            body["sequence"] = sequence
        if portfolio_group_id is not None:
            path_params["portfolioGroupId"] = portfolio_group_id
        if calculated_trade_id is not None:
            path_params["calculatedTradeId"] = calculated_trade_id
        if trade_id is not None:
            path_params["tradeId"] = trade_id
