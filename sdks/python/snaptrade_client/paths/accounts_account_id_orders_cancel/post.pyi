...
class CancelUserAccountOrder(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def cancel_user_account_order(
        self: "CancelUserAccountOrder[CommercialApiKeyAuth]",
    ...
    @typing.overload
    def cancel_user_account_order(
        self: "CancelUserAccountOrder[PersonalApiKeyAuth]",
        brokerage_order_id: str,
        account_id: str,
...
class ApiForpost(CancelUserAccountOrder[TAuth]):
    @typing.overload
    def post(
