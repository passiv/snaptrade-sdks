...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["symbol", "side", "type", "time_in_force", "amount", "limit_price", "stop_price", "post_only", "expiration_date", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["symbol", "side", "type", "time_in_force", "amount", "limit_price", "stop_price", "post_only", "expiration_date", ], str]):
    ...
    async def _acrypto_spot_preview_order_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/accounts/{accountId}/trading/crypto/spot/previewOrder',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
