...
from snaptrade_client.model.calculated_trade import CalculatedTrade as CalculatedTradeSchema
...
SchemaFor200ResponseBodyApplicationJson = CalculatedTradeSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CalculatedTrade
...
class BaseApi(api_client.Api):
    ...
    def _list_calculated_trades_mapped_args(
        self,
    ...
    async def _alist_calculated_trades_oapg(
        self,
        path_params: typing.Optional[dict] = {},
    ...
    def _list_calculated_trades_oapg(
        self,
        path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class ListCalculatedTrades(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_calculated_trades(
        self,
        portfolio_group_id: typing.Optional[str] = None,
        path_params: typing.Optional[dict] = {},
    ) -> typing.Union[
        ...
        args = self._list_calculated_trades_mapped_args(
            path_params=path_params,
            portfolio_group_id=portfolio_group_id,
        )
        return await self._alist_calculated_trades_oapg(
    ...
    def list_calculated_trades(
        ...
        return self._list_calculated_trades_oapg(
            path_params=args.path,
        )
