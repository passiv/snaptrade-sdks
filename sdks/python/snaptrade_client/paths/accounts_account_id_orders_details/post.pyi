...
class GetUserAccountOrderDetail(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def get_user_account_order_detail(
        self: "GetUserAccountOrderDetail[CommercialApiKeyAuth]",
    ...
    @typing.overload
    def get_user_account_order_detail(
        self: "GetUserAccountOrderDetail[PersonalApiKeyAuth]",
        brokerage_order_id: str,
        account_id: str,
...
class ApiForpost(GetUserAccountOrderDetail[TAuth]):
    @typing.overload
    def post(
