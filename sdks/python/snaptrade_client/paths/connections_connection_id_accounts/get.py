...
class BaseApi(api_client.Api):
    ...
    def _list_connection_accounts_mapped_args(
        self,
    ...
    async def _alist_connection_accounts_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        header_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/connections/{connectionId}/accounts',
            auth_settings=_auth,
    ...
    def _list_connection_accounts_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        header_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
...
class ListConnectionAccounts(BaseApi, typing.Generic[TAuth]):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_connection_accounts(
        self,
        connection_id: typing.Optional[str] = None,
        user_id: typing.Optional[str] = None,
        user_secret: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        return await self._alist_connection_accounts_oapg(
    ...
    def list_connection_accounts(
        ...
        return self._list_connection_accounts_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )
