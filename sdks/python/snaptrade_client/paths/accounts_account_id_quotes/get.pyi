...
class GetUserAccountQuotes(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def get_user_account_quotes(
        self: "GetUserAccountQuotes[CommercialApiKeyAuth]",
        symbols: str,
        account_id: str,
        user_id: str,
        user_secret: str,
    ...
    @typing.overload
    def get_user_account_quotes(
        self: "GetUserAccountQuotes[PersonalApiKeyAuth]",
        symbols: str,
        account_id: str,
        use_ticker: typing.Optional[bool] = None,
...
class ApiForget(GetUserAccountQuotes[TAuth]):
    @typing.overload
    def get(
