...
class BaseApi(api_client.Api):
    ...
    def _crypto_spot_place_order_mapped_args(
        self,
    ...
    async def _acrypto_spot_place_order_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/trading/crypto/spot/placeOrder',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _crypto_spot_place_order_oapg(
        self,
        body: typing.Any = None,
        query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CryptoSpotPlaceOrder(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acrypto_spot_place_order(
        self,
        body: typing.Optional[typing.Any] = None,
        account_id: typing.Optional[str] = None,
        symbol: typing.Optional[CryptocurrencyPair] = None,
        ...
        **kwargs,
        ...
        args = self._crypto_spot_place_order_mapped_args(
            body=body,
        ...
        return await self._acrypto_spot_place_order_oapg(
            body=args.body,
            query_params=args.query,
            **kwargs,
        )
    
    def crypto_spot_place_order(
        self,
        body: typing.Optional[typing.Any] = None,
        account_id: typing.Optional[str] = None,
        symbol: typing.Optional[CryptocurrencyPair] = None,
        ...
        return self._crypto_spot_place_order_oapg(
            body=args.body,
            query_params=args.query,
        )
