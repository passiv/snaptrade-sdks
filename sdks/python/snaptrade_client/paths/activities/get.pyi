...
class GetActivities(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def get_activities(
        self: "GetActivities[CommercialApiKeyAuth]",
        user_id: str,
        user_secret: str,
    ...
    @typing.overload
    def get_activities(
        self: "GetActivities[PersonalApiKeyAuth]",
        start_date: typing.Optional[date] = None,
        end_date: typing.Optional[date] = None,
        accounts: typing.Optional[str] = None,
        brokerage_authorizations: typing.Optional[str] = None,
...
class ApiForget(GetActivities[TAuth]):
    @typing.overload
    def get(
