...
class BaseApi(api_client.Api):
    ...
    def _list_portfolio_accounts_mapped_args(
        self,
    ...
    async def _alist_portfolio_accounts_oapg(
        self,
        path_params: typing.Optional[dict] = {},
    ...
    def _list_portfolio_accounts_oapg(
        self,
        path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class ListPortfolioAccounts(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_portfolio_accounts(
        self,
        portfolio_group_id: typing.Optional[str] = None,
        path_params: typing.Optional[dict] = {},
    ) -> typing.Union[
        ...
        args = self._list_portfolio_accounts_mapped_args(
            path_params=path_params,
            portfolio_group_id=portfolio_group_id,
        )
        return await self._alist_portfolio_accounts_oapg(
    ...
    def list_portfolio_accounts(
        ...
        return self._list_portfolio_accounts_oapg(
            path_params=args.path,
        )
