...
class PreviewCryptoOrder(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def preview_crypto_order(
        self: "PreviewCryptoOrder[CommercialApiKeyAuth]",
    ...
    @typing.overload
    def preview_crypto_order(
        self: "PreviewCryptoOrder[PersonalApiKeyAuth]",
        instrument: CryptoTradingInstrument,
        side: ActionStrict,
        type: str,
        time_in_force: str,
...
class ApiForpost(PreviewCryptoOrder[TAuth]):
    @typing.overload
    def post(
