...
class GetUserHoldings(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def get_user_holdings(
        self: "GetUserHoldings[CommercialApiKeyAuth]",
        account_id: str,
        user_id: str,
        user_secret: str,
    ...
    @typing.overload
    def get_user_holdings(
        self: "GetUserHoldings[PersonalApiKeyAuth]",
        account_id: str,
...
class ApiForget(GetUserHoldings[TAuth]):
    @typing.overload
    def get(
