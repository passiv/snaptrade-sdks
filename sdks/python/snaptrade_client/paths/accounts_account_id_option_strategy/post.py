...
class GetOptionStrategy(BaseApi):
    ...
    def get_option_strategy(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,dict, frozendict.frozendict,  None, dict, list, schemas.Primitive] = None,
        underlying_symbol_id: typing.Any = None,
        legs: typing.Any = None,
        strategy_type: typing.Any = None,
        ...
        if body is None:
            body = {}
        if isinstance(body, dict) and underlying_symbol_id is not None:
            body["underlying_symbol_id"] = underlying_symbol_id
        if isinstance(body, dict) and legs is not None:
            body["legs"] = legs
        if isinstance(body, dict) and strategy_type is not None:
