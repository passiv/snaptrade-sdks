...
from snaptrade_client.model.crypto_spot_order_preview import CryptoSpotOrderPreview as CryptoSpotOrderPreviewSchema

from snaptrade_client.type.cryptocurrency_pair import CryptocurrencyPair
from snaptrade_client.type.model400_failed_request_response import Model400FailedRequestResponse
from snaptrade_client.type.crypto_spot_order_preview import CryptoSpotOrderPreview
...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_id", "symbol", "side", "type", "time_in_force", "amount", "limit_price", "stop_price", "post_only", "expiration_date", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_id", "symbol", "side", "type", "time_in_force", "amount", "limit_price", "stop_price", "post_only", "expiration_date", ], str]):
...
SchemaFor200ResponseBodyApplicationJson = CryptoSpotOrderPreviewSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CryptoSpotOrderPreview
...
class BaseApi(api_client.Api):
    ...
    def _crypto_spot_preview_order_mapped_args(
        self,
    ...
    async def _acrypto_spot_preview_order_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/trading/crypto/spot/previewOrder',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _crypto_spot_preview_order_oapg(
        self,
        body: typing.Any = None,
        query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CryptoSpotPreviewOrder(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acrypto_spot_preview_order(
        self,
        body: typing.Optional[typing.Any] = None,
        account_id: typing.Optional[str] = None,
        symbol: typing.Optional[CryptocurrencyPair] = None,
        ...
        **kwargs,
        ...
        args = self._crypto_spot_preview_order_mapped_args(
            body=body,
        ...
        return await self._acrypto_spot_preview_order_oapg(
            body=args.body,
            query_params=args.query,
            **kwargs,
        )
    
    def crypto_spot_preview_order(
        self,
        body: typing.Optional[typing.Any] = None,
        account_id: typing.Optional[str] = None,
        symbol: typing.Optional[CryptocurrencyPair] = None,
        ...
        return self._crypto_spot_preview_order_oapg(
            body=args.body,
            query_params=args.query,
        )
