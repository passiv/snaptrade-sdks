...
class GetSymbolsByTicker(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def get_symbols_by_ticker(
        self: "GetSymbolsByTicker[CommercialApiKeyAuth]",
        query: str,
    ...
    @typing.overload
    def get_symbols_by_ticker(
        self: "GetSymbolsByTicker[PersonalApiKeyAuth]",
        query: str,
        path_params: typing.Optional[dict] = ...,
        validate: bool = ...,
    ) -> typing.Any: ...
...
class ApiForget(GetSymbolsByTicker[TAuth]):
    @typing.overload
    def get(
