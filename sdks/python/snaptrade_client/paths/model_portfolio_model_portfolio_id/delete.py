...
class BaseApi(api_client.Api):
    ...
    def _delete_model_portfolio_by_id_mapped_args(
        self,
    ...
    async def _adelete_model_portfolio_by_id_oapg(
        self,
        path_params: typing.Optional[dict] = {},
...
class DeleteModelPortfolioById(BaseApi):
    ...
    async def adelete_model_portfolio_by_id(
        self,
        model_portfolio_id: typing.Optional[str] = None,
        path_params: typing.Optional[dict] = {},
    ) -> typing.Union[
        ...
        args = self._delete_model_portfolio_by_id_mapped_args(
            path_params=path_params,
            model_portfolio_id=model_portfolio_id,
        )
        return await self._adelete_model_portfolio_by_id_oapg(
