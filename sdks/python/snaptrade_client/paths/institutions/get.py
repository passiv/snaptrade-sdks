...
from snaptrade_client.model.institution import Institution as InstitutionSchema

from snaptrade_client.type.institution import Institution
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['InstitutionSchema']:
...
class BaseApi(api_client.Api):
    ...
    def _list_institutions_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_institutions_oapg(
        self,
...
class ListInstitutions(BaseApi, typing.Generic[TAuth]):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_institutions(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_institutions_mapped_args(
        )
        return await self._alist_institutions_oapg(
            **kwargs,
        )
    ...
    def list_institutions(
        ...
        return self._list_institutions_oapg(
        )
