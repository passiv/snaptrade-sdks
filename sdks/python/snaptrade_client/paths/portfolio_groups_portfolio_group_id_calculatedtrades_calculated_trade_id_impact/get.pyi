...
from snaptrade_client.model.trade_impact import TradeImpact as TradeImpactSchema

from snaptrade_client.type.trade_impact import TradeImpact
...
class BaseApi(api_client.Api):
    ...
    def _get_calculated_trades_impact_mapped_args(
        self,
    ...
    async def _aget_calculated_trades_impact_oapg(
        self,
        path_params: typing.Optional[dict] = {},
    ...
    def _get_calculated_trades_impact_oapg(
        self,
        path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class GetCalculatedTradesImpact(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_calculated_trades_impact(
        self,
        portfolio_group_id: typing.Optional[str] = None,
        calculated_trade_id: typing.Optional[str] = None,
        path_params: typing.Optional[dict] = {},
        ...
        args = self._get_calculated_trades_impact_mapped_args(
            path_params=path_params,
            portfolio_group_id=portfolio_group_id,
            calculated_trade_id=calculated_trade_id,
        )
        return await self._aget_calculated_trades_impact_oapg(
    ...
    def get_calculated_trades_impact(
        ...
        return self._get_calculated_trades_impact_oapg(
            path_params=args.path,
        )
