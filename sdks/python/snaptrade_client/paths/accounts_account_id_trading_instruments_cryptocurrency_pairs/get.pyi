...
class SearchCryptocurrencyPairInstruments(BaseApi, typing.Generic[TAuth]):
    ...
    def search_cryptocurrency_pair_instruments(
        self: "SearchCryptocurrencyPairInstruments[CommercialApiKeyAuth]",
        account_id: str,
        user_id: str,
        user_secret: str,
    ...
    @typing.overload
    def search_cryptocurrency_pair_instruments(
        self: "SearchCryptocurrencyPairInstruments[PersonalApiKeyAuth]",
        account_id: str,
        base: typing.Optional[str] = None,
        quote: typing.Optional[str] = None,
...
class ApiForget(SearchCryptocurrencyPairInstruments[TAuth]):
    @typing.overload
    def get(
