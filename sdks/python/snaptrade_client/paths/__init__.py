...
class PathValues(str, enum.Enum):
    ...
    CONNECTION_CONNECTION_ID = "/connection/{connectionId}"
    ...
    AUTHORIZATIONS_AUTHORIZATION_ID_ACCOUNTS = "/authorizations/{authorizationId}/accounts"
    ACCOUNTS = "/accounts"
    ...
    ACCOUNTS_ACCOUNT_ID_POSITIONS_ALL = "/accounts/{accountId}/positions/all"
    ...
    ACCOUNTS_ACCOUNT_ID_TRADING_OPTIONS_IMPACT = "/accounts/{accountId}/trading/options/impact"
    ACCOUNTS_ACCOUNT_ID_QUOTES_OPTIONS = "/accounts/{accountId}/quotes/options"
    ...
    ACCOUNTS_ACCOUNT_ID_TRADING_COMPLEX = "/accounts/{accountId}/trading/complex"
    ...
    CONNECTIONS_AUTHORIZATION_ID_ACCOUNTS = "/connections/{authorizationId}/accounts"
    ...
    ACCOUNTS_ACCOUNT_ID_ORDERS_DETAILS_V2_BROKERAGE_ORDER_ID = "/accounts/{accountId}/orders/details/v2/{brokerageOrderId}"
