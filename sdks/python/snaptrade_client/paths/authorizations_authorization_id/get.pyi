...
class DetailBrokerageAuthorization(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def detail_brokerage_authorization(
        self: "DetailBrokerageAuthorization[CommercialApiKeyAuth]",
    ...
    @typing.overload
    def detail_brokerage_authorization(
        self: "DetailBrokerageAuthorization[PersonalApiKeyAuth]",
        authorization_id: str,
...
class ApiForget(DetailBrokerageAuthorization[TAuth]):
    @typing.overload
    def get(
