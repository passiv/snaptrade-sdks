...
class RemoveBrokerageAuthorization(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def remove_brokerage_authorization(
        self: "RemoveBrokerageAuthorization[CommercialApiKeyAuth]",
    ...
    @typing.overload
    def remove_brokerage_authorization(
        self: "RemoveBrokerageAuthorization[PersonalApiKeyAuth]",
        authorization_id: str,
...
class ApiFordelete(RemoveBrokerageAuthorization[TAuth]):
    @typing.overload
    def delete(
    ...
    @typing.overload
    def delete(
        self: "ApiFordelete[PersonalApiKeyAuth]",
        authorization_id: str,
        user_id: typing.Optional[typing_extensions.Never] = None,
        user_secret: typing.Optional[typing_extensions.Never] = None,
        query_params: typing.Optional[dict] = ...,
