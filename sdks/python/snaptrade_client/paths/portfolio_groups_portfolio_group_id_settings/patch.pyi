...
from snaptrade_client.model.portfolio_group_settings import PortfolioGroupSettings as PortfolioGroupSettingsSchema
...
SchemaFor200ResponseBody = PortfolioGroupSettingsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PortfolioGroupSettings
...
class BaseApi(api_client.Api):
    ...
    def _update_portfolio_settings_mapped_args(
        self,
    ...
    async def _aupdate_portfolio_settings_oapg(
        self,
        path_params: typing.Optional[dict] = {},
...
class UpdatePortfolioSettings(BaseApi):
    ...
    async def aupdate_portfolio_settings(
        self,
        portfolio_group_id: typing.Optional[str] = None,
        path_params: typing.Optional[dict] = {},
    ) -> typing.Union[
        ...
        args = self._update_portfolio_settings_mapped_args(
            path_params=path_params,
            portfolio_group_id=portfolio_group_id,
        )
        return await self._aupdate_portfolio_settings_oapg(
