...
class BaseApi(api_client.Api):
    ...
    def _list_brokerage_authorization_accounts_mapped_args(
        self,
    ...
    async def _alist_brokerage_authorization_accounts_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        header_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/authorizations/{authorizationId}/accounts',
            auth_settings=_auth,
    ...
    def _list_brokerage_authorization_accounts_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        header_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
...
class ListBrokerageAuthorizationAccounts(BaseApi, typing.Generic[TAuth]):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_brokerage_authorization_accounts(
        self,
        authorization_id: typing.Optional[str] = None,
        user_id: typing.Optional[str] = None,
        user_secret: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_brokerage_authorization_accounts_mapped_args(
            path_params=path_params,
            authorization_id=authorization_id,
            user_id=user_id,
            user_secret=user_secret,
        )
        return await self._alist_brokerage_authorization_accounts_oapg(
    ...
    def list_brokerage_authorization_accounts(
        self,
        authorization_id: typing.Optional[str] = None,
        user_id: typing.Optional[str] = None,
        user_secret: typing.Optional[str] = None,
        ...
        return self._list_brokerage_authorization_accounts_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )
