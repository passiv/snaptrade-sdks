...
class ListBrokerageAuthorizationAccounts(BaseApi, typing.Generic[TAuth]):
    ...
    def list_brokerage_authorization_accounts(
        self: "ListBrokerageAuthorizationAccounts[CommercialApiKeyAuth]",
    ...
    @typing.overload
    def list_brokerage_authorization_accounts(
        self: "ListBrokerageAuthorizationAccounts[PersonalApiKeyAuth]",
        authorization_id: str,
...
class ApiForget(ListBrokerageAuthorizationAccounts[TAuth]):
    @typing.overload
    def get(
