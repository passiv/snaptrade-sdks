...
class SessionEvents(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def session_events(
        self: "SessionEvents[CommercialApiKeyAuth]",
    ...
    @typing.overload
    def session_events(
        self: "SessionEvents[PersonalApiKeyAuth]",
        partner_client_id: str,
        user_id: typing.Optional[str] = None,
        session_id: typing.Optional[str] = None,
        query_params: typing.Optional[dict] = ...,
...
class ApiForget(SessionEvents[TAuth]):
    @typing.overload
    def get(
