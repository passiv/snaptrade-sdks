...
class SymbolSearchUserAccount(BaseApi, typing.Generic[TAuth]):
    @typing.overload
    def symbol_search_user_account(
        self: "SymbolSearchUserAccount[CommercialApiKeyAuth]",
        account_id: str,
        user_id: str,
        user_secret: str,
    ...
    @typing.overload
    def symbol_search_user_account(
        self: "SymbolSearchUserAccount[PersonalApiKeyAuth]",
        account_id: str,
        substring: typing.Optional[str] = None,
...
class ApiForpost(SymbolSearchUserAccount[TAuth]):
    @typing.overload
    def post(
