...
from snaptrade_client.model.option_impact import OptionImpact as OptionImpactSchema
...
from snaptrade_client.model.mleg_trade_form import MlegTradeForm as MlegTradeFormSchema

from snaptrade_client.type.option_impact import OptionImpact
from snaptrade_client.type.mleg_leg import MlegLeg
from snaptrade_client.type.mleg_trade_form import MlegTradeForm
...
# body param
SchemaForRequestBodyApplicationJson = MlegTradeFormSchema


request_body_mleg_trade_form = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OptionImpactSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_option_impact_mapped_args(
        self,
        body: typing.Optional[MlegTradeForm] = None,
    ...
    async def _aget_option_impact_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/accounts/{accountId}/trading/options/impact',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_mleg_trade_form.serialize(body, content_type)
...
class GetOptionImpact(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_option_impact(
        self,
        body: typing.Optional[MlegTradeForm] = None,
        order_type: typing.Optional[MlegOrderTypeStrict] = None,
        time_in_force: typing.Optional[TimeInForceStrict] = None,
        ...
        **kwargs,
        ...
        return await self._aget_option_impact_oapg(
            body=args.body,
    ...
    def get_option_impact(
        ...
        return self._get_option_impact_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )
