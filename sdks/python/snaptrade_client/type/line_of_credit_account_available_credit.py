...
class RequiredLineOfCreditAccountAvailableCredit(TypedDict):
    pass

class OptionalLineOfCreditAccountAvailableCredit(TypedDict, total=False):
    amount: typing.Optional[typing.Union[int, float]]

    currency: typing.Optional[str]

class LineOfCreditAccountAvailableCredit(RequiredLineOfCreditAccountAvailableCredit, OptionalLineOfCreditAccountAvailableCredit):
    pass
