...
class RequiredMutualFundInstrument(TypedDict):
    # Type of security instrument.
    kind: Literal["mutualfund"]
...
class OptionalMutualFundInstrument(TypedDict, total=False):
...
class MutualFundInstrument(RequiredMutualFundInstrument, OptionalMutualFundInstrument):
    pass
