...
class RequiredConnectionAccountsResponse(TypedDict):
    # Accounts returned for the request.
    results: typing.List[ConnectionAccount]

class OptionalConnectionAccountsResponse(TypedDict, total=False):
    pass

class ConnectionAccountsResponse(RequiredConnectionAccountsResponse, OptionalConnectionAccountsResponse):
    pass
