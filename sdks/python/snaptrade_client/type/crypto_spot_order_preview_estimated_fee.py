...
class RequiredCryptoSpotOrderPreviewEstimatedFee(TypedDict):
...
class CryptoSpotOrderPreviewEstimatedFee(RequiredCryptoSpotOrderPreviewEstimatedFee, OptionalCryptoSpotOrderPreviewEstimatedFee):
    pass
