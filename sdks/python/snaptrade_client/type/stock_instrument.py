...
class RequiredStockInstrument(TypedDict):
...
class OptionalStockInstrument(TypedDict, total=False):
...
class StockInstrument(RequiredStockInstrument, OptionalStockInstrument):
    pass
