...
class RequiredDepositAccountSyncStatus(TypedDict):
    pass

class OptionalDepositAccountSyncStatus(TypedDict, total=False):
    transactions: TransactionsStatus

    balances: HoldingsSyncStatusDateNullable

class DepositAccountSyncStatus(RequiredDepositAccountSyncStatus, OptionalDepositAccountSyncStatus):
    pass
