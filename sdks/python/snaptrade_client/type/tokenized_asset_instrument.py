...
from snaptrade_client.type.underlying_tokenized_asset_instrument import UnderlyingTokenizedAssetInstrument

class RequiredTokenizedAssetInstrument(TypedDict):
    # Type of security instrument.
    kind: Literal["tokenized_asset"]
...
class OptionalTokenizedAssetInstrument(TypedDict, total=False):
    # Display name of the underlying stock or ETF, when available.
    description: str

class TokenizedAssetInstrument(RequiredTokenizedAssetInstrument, OptionalTokenizedAssetInstrument):
    pass
