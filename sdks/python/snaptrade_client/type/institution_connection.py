...
class RequiredInstitutionConnection(TypedDict):
    methods: InstitutionConnectionMethods

    scopes: InstitutionConnectionScopes

class OptionalInstitutionConnection(TypedDict, total=False):
    pass

class InstitutionConnection(RequiredInstitutionConnection, OptionalInstitutionConnection):
    pass
