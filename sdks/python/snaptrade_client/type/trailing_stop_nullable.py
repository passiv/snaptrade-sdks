...
class RequiredTrailingStopNullable(TypedDict):
...
class OptionalTrailingStopNullable(TypedDict, total=False):
    pass

class TrailingStopNullable(RequiredTrailingStopNullable, OptionalTrailingStopNullable):
    pass
