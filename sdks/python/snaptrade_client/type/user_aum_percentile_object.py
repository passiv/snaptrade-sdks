...
class RequiredUserAumPercentileObject(TypedDict):
    pass

class OptionalUserAumPercentileObject(TypedDict, total=False):
...
class UserAumPercentileObject(RequiredUserAumPercentileObject, OptionalUserAumPercentileObject):
    pass
