...
from snaptrade_client.type.institution_connection_methods import InstitutionConnectionMethods
from snaptrade_client.type.institution_connection_scopes import InstitutionConnectionScopes

class RequiredInstitutionConnectionNullable(TypedDict):
    methods: InstitutionConnectionMethods

    scopes: InstitutionConnectionScopes

class OptionalInstitutionConnectionNullable(TypedDict, total=False):
    pass

class InstitutionConnectionNullable(RequiredInstitutionConnectionNullable, OptionalInstitutionConnectionNullable):
    pass
