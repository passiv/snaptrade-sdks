...
class RequiredFutureOptionInstrument(TypedDict):
    # Type of security instrument.
    kind: Literal["future_option"]
...
class OptionalFutureOptionInstrument(TypedDict, total=False):
...
class FutureOptionInstrument(RequiredFutureOptionInstrument, OptionalFutureOptionInstrument):
    pass
