...
from snaptrade_client.type.line_of_credit_account_available_credit import LineOfCreditAccountAvailableCredit
...
class OptionalLineOfCreditAccount(TypedDict, total=False):
    ...
    available_credit: typing.Optional[LineOfCreditAccountAvailableCredit]

    # The date the account's next payment is due, in `YYYY-MM-DD` format. Omitted when no such data is available.
    next_payment_date: typing.Optional[date]
