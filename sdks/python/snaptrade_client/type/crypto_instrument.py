...
class RequiredCryptoInstrument(TypedDict):
...
class OptionalCryptoInstrument(TypedDict, total=False):
...
class CryptoInstrument(RequiredCryptoInstrument, OptionalCryptoInstrument):
    pass
