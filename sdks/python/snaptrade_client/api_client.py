...
from snaptrade_client.exceptions import ApiTypeError, ApiValueError, ApiException
from snaptrade_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'Konfig/2.3.0/python'
