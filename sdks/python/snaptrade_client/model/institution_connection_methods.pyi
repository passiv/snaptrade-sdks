...
class InstitutionConnectionMethods(
    schemas.ListSchema
):
    """NOTE:
    This class is auto generated by Konfig (https://konfigthis.com)

    Ways an end user can connect.
- `OAUTH`: the user signs in on the institution's own site and approves access.
- `CREDENTIALS`: the user enters their login details in the SnapTrade Connection Portal.
- `API_KEY`: the user creates an API key at the institution and pastes it in.
