...
class InstitutionConnectionNullable(
    schemas.DictBase,
    schemas.NoneBase,
    schemas.Schema,
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def methods() -> typing.Type['InstitutionConnectionMethods']:
                return InstitutionConnectionMethods
        
            @staticmethod
            def scopes() -> typing.Type['InstitutionConnectionScopes']:
                return InstitutionConnectionScopes
            __annotations__ = {
                "methods": methods,
                "scopes": scopes,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["methods"]) -> 'InstitutionConnectionMethods': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["scopes"]) -> 'InstitutionConnectionScopes': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> MetaOapg.additional_properties: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["methods"], typing_extensions.Literal["scopes"], str, ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["methods"]) -> 'InstitutionConnectionMethods': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["scopes"]) -> 'InstitutionConnectionScopes': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[MetaOapg.additional_properties, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["methods"], typing_extensions.Literal["scopes"], str, ]):
