...
class InstitutionConnectionScopes(
    schemas.ListSchema
):
    """NOTE:
    This class is auto generated by Konfig (https://konfigthis.com)

    What a connection can do. `READ` is always present.
- `READ`: read accounts, balances, positions and activity.
- `TRADE`: place orders.
