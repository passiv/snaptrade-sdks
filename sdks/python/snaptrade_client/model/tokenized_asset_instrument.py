...
class TokenizedAssetInstrument(
    ...
    Canonical tokenized asset wrapper for a V2 position. Symbol and description
...
are provided only in underlying_instrument.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class kind(
                ...
                def TOKENIZED_ASSET(cls):
                    return cls("tokenized_asset")
            id = schemas.UUIDSchema
            symbol = schemas.StrSchema
        
            @staticmethod
            def underlying_instrument() -> typing.Type['UnderlyingTokenizedAssetInstrument']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["underlying_instrument"]) -> 'UnderlyingTokenizedAssetInstrument': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["symbol"], typing_extensions.Literal["underlying_instrument"], typing_extensions.Literal["kind"], typing_extensions.Literal["id"], typing_extensions.Literal["description"], str, ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["underlying_instrument"]) -> 'UnderlyingTokenizedAssetInstrument': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["symbol"], typing_extensions.Literal["underlying_instrument"], typing_extensions.Literal["kind"], typing_extensions.Literal["id"], typing_extensions.Literal["description"], str, ]):
