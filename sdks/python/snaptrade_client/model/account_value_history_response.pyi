...
class AccountValueHistoryResponse(
        ...
        class properties:
            ...
            class history(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AccountValueHistoryItem']:
                        return AccountValueHistoryItem
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['AccountValueHistoryItem'], typing.List['AccountValueHistoryItem']],
                ...
                def __getitem__(self, i: int) -> 'AccountValueHistoryItem':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["history"], typing_extensions.Literal["currency"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["history"], typing_extensions.Literal["currency"], str, ]):
