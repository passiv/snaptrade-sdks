...
class TargetAssetList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TargetAssetList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([TargetAsset]): Target percentage of a certain asset.  # noqa: E501

        Keyword Args:
            value ([TargetAsset]): Target percentage of a certain asset.  # noqa: E501
