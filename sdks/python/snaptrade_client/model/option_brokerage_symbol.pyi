...
class OptionBrokerageSymbol(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id"], typing_extensions.Literal["description"], typing_extensions.Literal["option_symbol"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id"], typing_extensions.Literal["description"], typing_extensions.Literal["option_symbol"], str, ]):
