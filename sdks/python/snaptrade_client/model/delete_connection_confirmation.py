...
class DeleteConnectionConfirmation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["detail"], typing_extensions.Literal["connection_id"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["detail"], typing_extensions.Literal["connection_id"], str, ]):
