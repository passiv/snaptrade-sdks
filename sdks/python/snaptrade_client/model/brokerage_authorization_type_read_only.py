...
class BrokerageAuthorizationTypeReadOnly(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, None, ],
        ...
        auth_type: typing.Union[MetaOapg.properties.auth_type, None, str, schemas.Unset] = schemas.unset,
        brokerage: typing.Union[MetaOapg.properties.brokerage, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[MetaOapg.additional_properties, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
