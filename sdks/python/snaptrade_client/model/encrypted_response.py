...
* Decrypting the encryptedMessageData
  ...
  ```
            ...
            class encryptedMessageData(
                ...
                def __new__(
                    ...
                    *args: typing.Union[dict, frozendict.frozendict, None, ],
                    encryptedMessage: typing.Union[MetaOapg.properties.encryptedMessage, None, str, schemas.Unset] = schemas.unset,
    ...
    def __new__(
        cls,
        *args: typing.Union[dict, frozendict.frozendict, None, ],
        encryptedSharedKey: typing.Union[MetaOapg.properties.encryptedSharedKey, None, str, schemas.Unset] = schemas.unset,
        encryptedMessageData: typing.Union[MetaOapg.properties.encryptedMessageData, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'EncryptedResponse':
        return super().__new__(
            cls,
