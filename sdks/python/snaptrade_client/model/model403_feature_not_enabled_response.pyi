...
class Model403FeatureNotEnabledResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["detail"], typing_extensions.Literal["default_code"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["detail"], typing_extensions.Literal["default_code"], str, ]):
