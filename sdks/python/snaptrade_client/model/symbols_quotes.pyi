...
class SymbolsQuotes(
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, None, ],
        ...
        bid_price: typing.Union[MetaOapg.properties.bid_price, None, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        ask_price: typing.Union[MetaOapg.properties.ask_price, None, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        last_trade_price: typing.Union[MetaOapg.properties.last_trade_price, None, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        bid_size: typing.Union[MetaOapg.properties.bid_size, None, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        ask_size: typing.Union[MetaOapg.properties.ask_size, None, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
