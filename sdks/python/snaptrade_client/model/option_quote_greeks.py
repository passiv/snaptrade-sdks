...
class OptionQuoteGreeks(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["delta"], typing_extensions.Literal["gamma"], typing_extensions.Literal["theta"], typing_extensions.Literal["vega"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["delta"], typing_extensions.Literal["gamma"], typing_extensions.Literal["theta"], typing_extensions.Literal["vega"], str, ]):
