...
class AccountInformationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.accounts_account_id_balances_get_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'accounts_account_id_balances_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.accounts_account_id_get_endpoint = _Endpoint(
            settings={
        ...
        self.accounts_account_id_holdings_get_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'accounts_account_id_holdings_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.accounts_account_id_positions_get_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'accounts_account_id_positions_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.accounts_account_id_put_endpoint = _Endpoint(
            settings={
                'response_type': ([Account],),
                'auth': [
                    'PartnerClientId',
                ...
                'endpoint_path': '/accounts/{accountId}',
                'operation_id': 'accounts_account_id_put',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        self.holdings_get_endpoint = _Endpoint(
            settings={
                'response_type': ([AccountHoldings],),
                'auth': [
                    'PartnerClientId',
    ...
    def accounts_account_id_balances_get(
        self,
        user_id,
        user_secret,
        account_id,
        **kwargs
        ...
        >>> thread = api.accounts_account_id_balances_get(user_id, user_secret, account_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['account_id'] = \
            account_id
        return self.accounts_account_id_balances_get_endpoint.call_with_http_info(**kwargs)
    ...
    def accounts_account_id_get(
        ...
        **kwargs
        ...
        >>> thread = api.accounts_account_id_get(user_id, user_secret, account_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['account_id'] = \
            account_id
        return self.accounts_account_id_get_endpoint.call_with_http_info(**kwargs)

    def accounts_account_id_holdings_get(
        self,
        account_id,
        user_id,
        user_secret,
        **kwargs
        ...
        >>> thread = api.accounts_account_id_holdings_get(account_id, user_id, user_secret, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['user_secret'] = \
            user_secret
        return self.accounts_account_id_holdings_get_endpoint.call_with_http_info(**kwargs)

    def accounts_account_id_positions_get(
        self,
        user_id,
        user_secret,
        account_id,
        **kwargs
        ...
        >>> thread = api.accounts_account_id_positions_get(user_id, user_secret, account_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['account_id'] = \
            account_id
        return self.accounts_account_id_positions_get_endpoint.call_with_http_info(**kwargs)
    ...
    def accounts_account_id_put(
        ...
        **kwargs
        ...
        >>> thread = api.accounts_account_id_put(user_id, user_secret, account_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['account_id'] = \
            account_id
        return self.accounts_account_id_put_endpoint.call_with_http_info(**kwargs)
    ...
    def accounts_get(
        ...
        **kwargs
        ...
        >>> thread = api.accounts_get(user_id, user_secret, async_req=True)
        >>> result = thread.get()
    ...
    def holdings_get(
        ...
        **kwargs
        ...
        >>> thread = api.holdings_get(user_id, user_secret, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['user_secret'] = \
            user_secret
        return self.holdings_get_endpoint.call_with_http_info(**kwargs)
