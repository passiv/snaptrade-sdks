...
```sh
pip install git+https://github.com/passiv/snaptrade-sdks/tree/master/sdks/python.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/passiv/snaptrade-sdks/tree/master/sdks/python.git`)
