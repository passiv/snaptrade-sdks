...
[![PyPI](https://img.shields.io/badge/PyPI-v13.0.23-blue)](https://pypi.org/project/snaptrade-python-sdk/13.0.23)
...
```sh
pip install snaptrade-python-sdk==13.0.23
```
...
commercial_api_key_client = SnapTrade(
...
list_connection_accounts_response = (
    commercial_api_key_client.connections.list_connection_accounts(
        connection_id="87b24961-b51e-4db8-9226-f198f6518a89",
        user_id="snaptrade-user-123",
        user_secret="adf2aa34-8219-40f7-a6b3-60156985cc61",
    )
...
```python
list_connection_accounts_response = (
    personal_api_key_client.connections.list_connection_accounts(
        connection_id="87b24961-b51e-4db8-9226-f198f6518a89",
    )
)
```
...
[`ConnectionAccountsResponse`](./snaptrade_client/type/connection_accounts_response.py)
