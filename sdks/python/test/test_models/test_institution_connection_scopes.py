...
from snaptrade_client.model.institution_connection_scopes import InstitutionConnectionScopes
from snaptrade_client import configuration


class TestInstitutionConnectionScopes(unittest.TestCase):
    """InstitutionConnectionScopes unit test stubs"""
    pass
