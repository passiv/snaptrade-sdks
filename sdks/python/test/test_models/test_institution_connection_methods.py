...
from snaptrade_client.model.institution_connection_methods import InstitutionConnectionMethods
from snaptrade_client import configuration


class TestInstitutionConnectionMethods(unittest.TestCase):
    """InstitutionConnectionMethods unit test stubs"""
    pass
