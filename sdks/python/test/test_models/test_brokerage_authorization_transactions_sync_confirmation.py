...
from snaptrade_client.model.brokerage_authorization_transactions_sync_confirmation import BrokerageAuthorizationTransactionsSyncConfirmation
from snaptrade_client import configuration


class TestBrokerageAuthorizationTransactionsSyncConfirmation(unittest.TestCase):
    """BrokerageAuthorizationTransactionsSyncConfirmation unit test stubs"""
    pass
