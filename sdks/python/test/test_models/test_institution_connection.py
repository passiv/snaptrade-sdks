...
from snaptrade_client.model.institution_connection import InstitutionConnection
from snaptrade_client import configuration


class TestInstitutionConnection(unittest.TestCase):
    """InstitutionConnection unit test stubs"""
    pass
