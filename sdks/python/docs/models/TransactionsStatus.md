# snaptrade_client.model.transactions_status.TransactionsStatus
...
**last_successful_sync** | None, str, date,  | NoneClass, str,  |  | [optional] value must conform to RFC-3339 full-date YYYY-MM-DD
