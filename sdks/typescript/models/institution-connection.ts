...
import { InstitutionConnection } from './institution-connection';
...
export interface InstitutionConnection {
     ...
     */
    'methods': Array<InstitutionConnectionMethodsEnum>;
    /**
     * What a connection can do. `READ` is always present. - `READ`: read accounts, balances, positions and activity. - `TRADE`: place orders. 
     * @type {Array<string>}
     * @memberof InstitutionConnection
     */
    'scopes': Array<InstitutionConnectionScopesEnum>;
}

type InstitutionConnectionMethodsEnum = 'OAUTH' | 'CREDENTIALS' | 'API_KEY'
type InstitutionConnectionScopesEnum = 'READ' | 'TRADE'
