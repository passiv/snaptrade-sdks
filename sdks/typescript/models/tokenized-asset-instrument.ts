 ...
 * @export
 * @interface TokenizedAssetInstrument
 */
export interface TokenizedAssetInstrument {
    [key: string]: any;

    /**
     * Type of security instrument.
     * @type {string}
     * @memberof TokenizedAssetInstrument
     */
    'kind': TokenizedAssetInstrumentKindEnum;
    /**
    ...
    /**
     * 
     * @type {UnderlyingTokenizedAssetInstrument}
     * @memberof TokenizedAssetInstrument
     */
    'underlying_instrument': UnderlyingTokenizedAssetInstrument;
}

type TokenizedAssetInstrumentKindEnum = 'tokenized_asset'
