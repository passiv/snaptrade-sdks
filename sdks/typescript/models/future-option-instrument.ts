 ...
 * @export
 * @interface FutureOptionInstrument
 */
export interface FutureOptionInstrument {
    [key: string]: any;

    /**
     * Type of security instrument.
     * @type {string}
     * @memberof FutureOptionInstrument
     */
    'kind': FutureOptionInstrumentKindEnum;
    /**
     ...
     * @memberof FutureOptionInstrument
     */
    'option_type': FutureOptionInstrumentOptionTypeEnum;
    /**
...
type FutureOptionInstrumentKindEnum = 'future_option'
type FutureOptionInstrumentOptionTypeEnum = 'CALL' | 'PUT'
