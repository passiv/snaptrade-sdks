...
/**
     ...
     */
    public function deleteConnectionWithHttpInfo($connection_id, $user_id, $user_secret, string $contentType = self::contentTypes['deleteConnection'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteConnectionAsyncWithHttpInfo($connection_id, $user_id, $user_secret, string $contentType = self::contentTypes['deleteConnection'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\DeleteConnectionConfirmation';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->deleteConnectionRequest($connection_id, $user_id, $user_secret, $contentType);
     ...
     */
    public function detailBrokerageAuthorizationWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['detailBrokerageAuthorization'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function detailBrokerageAuthorizationAsyncWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['detailBrokerageAuthorization'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\BrokerageAuthorization';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->detailBrokerageAuthorizationRequest($authorization_id, $user_id, $user_secret, $contentType);
     ...
     */
    public function disableBrokerageAuthorizationWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['disableBrokerageAuthorization'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function disableBrokerageAuthorizationAsyncWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['disableBrokerageAuthorization'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\BrokerageAuthorizationDisabledConfirmation';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->disableBrokerageAuthorizationRequest($authorization_id, $user_id, $user_secret, $contentType);
     ...
     */
    public function listBrokerageAuthorizationAccountsWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['listBrokerageAuthorizationAccounts'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listBrokerageAuthorizationAccountsAsyncWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['listBrokerageAuthorizationAccounts'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\Account[]';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->listBrokerageAuthorizationAccountsRequest($authorization_id, $user_id, $user_secret, $contentType);
     ...
     * @return array of \SnapTrade\Model\BrokerageAuthorization[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listBrokerageAuthorizationsWithHttpInfo($user_id, $user_secret, string $contentType = self::contentTypes['listBrokerageAuthorizations'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listBrokerageAuthorizationsAsyncWithHttpInfo($user_id, $user_secret, string $contentType = self::contentTypes['listBrokerageAuthorizations'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\BrokerageAuthorization[]';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->listBrokerageAuthorizationsRequest($user_id, $user_secret, $contentType);
    ...
    /**
     * Operation listConnectionAccounts
     *
     * List accounts
     *
     ...
     * @throws \SnapTrade\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SnapTrade\Model\ConnectionAccountsResponse|\SnapTrade\Model\Model401FailedRequestResponse|\SnapTrade\Model\Model404FailedRequestResponse
     */
    public function listConnectionAccounts(
        ...
        string $contentType = self::contentTypes['listConnectionAccounts'][0]
    )
    {
    ...
    /**
     * Operation listConnectionAccountsWithHttpInfo
     *
     * List accounts
     *
     * Returns all accounts that belong to the specified connection for the authenticated user.  The &#x60;results&#x60; list can contain multiple account kinds in the same response, including investment, deposit, and line of credit accounts. Use the &#x60;kind&#x60; discriminator to determine the shape for each account.  On Pay as you Go / Real-time, this endpoint refreshes each account&#39;s opening date and total net value (&#x60;net_value&#x60;) live from the institution on each call, along with funding date for &#x60;investment&#x60; accounts.  On Pay as you Go / Daily, this endpoint returns Daily data. Daily data is cached and refreshed once a day. Exact refresh timing may vary by institution. To force a refresh, use the [manual refresh endpoint](/reference/Connections/Connections_refreshBrokerageAuthorization).  Check your API key on the [Customer Dashboard billing page](https://dashboard.snaptrade.com/settings/billing) to see whether your plan includes real-time data.
     ...
     * @throws \SnapTrade\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SnapTrade\Model\ConnectionAccountsResponse|\SnapTrade\Model\Model401FailedRequestResponse|\SnapTrade\Model\Model404FailedRequestResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listConnectionAccountsWithHttpInfo($connection_id, $user_id, $user_secret, string $contentType = self::contentTypes['listConnectionAccounts'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SnapTrade\Model\ConnectionAccountsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SnapTrade\Model\ConnectionAccountsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\SnapTrade\Model\ConnectionAccountsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\SnapTrade\Model\ConnectionAccountsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SnapTrade\Model\ConnectionAccountsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation listConnectionAccountsAsync
     *
     * List accounts
     *
     * Returns all accounts that belong to the specified connection for the authenticated user.  The &#x60;results&#x60; list can contain multiple account kinds in the same response, including investment, deposit, and line of credit accounts. Use the &#x60;kind&#x60; discriminator to determine the shape for each account.  On Pay as you Go / Real-time, this endpoint refreshes each account&#39;s opening date and total net value (&#x60;net_value&#x60;) live from the institution on each call, along with funding date for &#x60;investment&#x60; accounts.  On Pay as you Go / Daily, this endpoint returns Daily data. Daily data is cached and refreshed once a day. Exact refresh timing may vary by institution. To force a refresh, use the [manual refresh endpoint](/reference/Connections/Connections_refreshBrokerageAuthorization).  Check your API key on the [Customer Dashboard billing page](https://dashboard.snaptrade.com/settings/billing) to see whether your plan includes real-time data.
    ...
    /**
     * Operation listConnectionAccountsAsyncWithHttpInfo
     *
     * List accounts
     *
     * Returns all accounts that belong to the specified connection for the authenticated user.  The &#x60;results&#x60; list can contain multiple account kinds in the same response, including investment, deposit, and line of credit accounts. Use the &#x60;kind&#x60; discriminator to determine the shape for each account.  On Pay as you Go / Real-time, this endpoint refreshes each account&#39;s opening date and total net value (&#x60;net_value&#x60;) live from the institution on each call, along with funding date for &#x60;investment&#x60; accounts.  On Pay as you Go / Daily, this endpoint returns Daily data. Daily data is cached and refreshed once a day. Exact refresh timing may vary by institution. To force a refresh, use the [manual refresh endpoint](/reference/Connections/Connections_refreshBrokerageAuthorization).  Check your API key on the [Customer Dashboard billing page](https://dashboard.snaptrade.com/settings/billing) to see whether your plan includes real-time data.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listConnectionAccountsAsyncWithHttpInfo($connection_id, $user_id, $user_secret, string $contentType = self::contentTypes['listConnectionAccounts'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\ConnectionAccountsResponse';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->listConnectionAccountsRequest($connection_id, $user_id, $user_secret, $contentType);
    ...
    public function listConnectionAccountsRequest($connection_id, $user_id, $user_secret, string $contentType = self::contentTypes['listConnectionAccounts'][0])
    {
        ...
        if ($user_id === SENTINEL_VALUE || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter user_id when calling listConnectionAccounts'
            );
        }
        // Check if $user_secret is a string
        if ($user_secret !== SENTINEL_VALUE && !is_string($user_secret)) {
        ...
        if ($user_secret === SENTINEL_VALUE || (is_array($user_secret) && count($user_secret) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter user_secret when calling listConnectionAccounts'
            );
        }
     ...
     */
    public function refreshBrokerageAuthorizationWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['refreshBrokerageAuthorization'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshBrokerageAuthorizationAsyncWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['refreshBrokerageAuthorization'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\BrokerageAuthorizationRefreshConfirmation';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->refreshBrokerageAuthorizationRequest($authorization_id, $user_id, $user_secret, $contentType);
     ...
     */
    public function syncBrokerageAuthorizationTransactionsWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['syncBrokerageAuthorizationTransactions'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function syncBrokerageAuthorizationTransactionsAsyncWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['syncBrokerageAuthorizationTransactions'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\BrokerageAuthorizationTransactionsSyncConfirmation';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->syncBrokerageAuthorizationTransactionsRequest($authorization_id, $user_id, $user_secret, $contentType);
