...
/**
     ...
     */
    public function removeBrokerageAuthorizationWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['removeBrokerageAuthorization'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeBrokerageAuthorizationAsyncWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['removeBrokerageAuthorization'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->removeBrokerageAuthorizationRequest($authorization_id, $user_id, $user_secret, $contentType);
     ...
     */
    public function sessionEventsWithHttpInfo($partner_client_id, $user_id = null, $session_id = null, string $contentType = self::contentTypes['sessionEvents'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sessionEventsAsyncWithHttpInfo($partner_client_id, $user_id = null, $session_id = null, string $contentType = self::contentTypes['sessionEvents'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\ConnectionsSessionEvents200ResponseInner[]';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->sessionEventsRequest($partner_client_id, $user_id, $session_id, $contentType);
