...
/**
     ...
     */
    public function addSubscriptionWithHttpInfo($user_id, $user_secret, $trade_detection_add_subscription_request, string $contentType = self::contentTypes['addSubscription'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addSubscriptionAsyncWithHttpInfo($user_id, $user_secret, $trade_detection_add_subscription_request, string $contentType = self::contentTypes['addSubscription'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\TradeDetectionSubscription';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->addSubscriptionRequest($user_id, $user_secret, $trade_detection_add_subscription_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAccountOrderDetailV2AsyncWithHttpInfo($account_id, $brokerage_order_id, $user_id, $user_secret, string $contentType = self::contentTypes['getUserAccountOrderDetailV2'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\AccountOrderRecordV2';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getUserAccountOrderDetailV2Request($account_id, $brokerage_order_id, $user_id, $user_secret, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAccountOrdersV2AsyncWithHttpInfo($user_id, $user_secret, $account_id, $state = null, $days = null, string $contentType = self::contentTypes['getUserAccountOrdersV2'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\AccountOrdersV2Response';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getUserAccountOrdersV2Request($user_id, $user_secret, $account_id, $state, $days, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAccountRecentOrdersV2AsyncWithHttpInfo($user_id, $user_secret, $account_id, $only_executed = null, string $contentType = self::contentTypes['getUserAccountRecentOrdersV2'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\AccountOrdersV2Response';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getUserAccountRecentOrdersV2Request($user_id, $user_secret, $account_id, $only_executed, $contentType);
     ...
     */
    public function listConnectionAccountsWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['listConnectionAccounts'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listConnectionAccountsAsyncWithHttpInfo($authorization_id, $user_id, $user_secret, string $contentType = self::contentTypes['listConnectionAccounts'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\ConnectionAccount[]';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->listConnectionAccountsRequest($authorization_id, $user_id, $user_secret, $contentType);
     ...
     */
    public function listSubscriptionsWithHttpInfo(string $contentType = self::contentTypes['listSubscriptions'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSubscriptionsAsyncWithHttpInfo(string $contentType = self::contentTypes['listSubscriptions'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\TradeDetectionSubscription[]';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->listSubscriptionsRequest($contentType);
