...
/**
     ...
     */
    public function checkWithHttpInfo(string $contentType = self::contentTypes['check'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkAsyncWithHttpInfo(string $contentType = self::contentTypes['check'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\Status';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->checkRequest($contentType);
