...
/**
     ...
     */
    public function getUserAumPercentileWithHttpInfo($user_id, $user_secret, string $contentType = self::contentTypes['getUserAumPercentile'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAumPercentileAsyncWithHttpInfo($user_id, $user_secret, string $contentType = self::contentTypes['getUserAumPercentile'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\UserAumPercentileResponse';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getUserAumPercentileRequest($user_id, $user_secret, $contentType);
