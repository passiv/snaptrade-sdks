...
/**
     ...
     */
    public function deleteSnapTradeUserWithHttpInfo($user_id, string $contentType = self::contentTypes['deleteSnapTradeUser'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteSnapTradeUserAsyncWithHttpInfo($user_id, string $contentType = self::contentTypes['deleteSnapTradeUser'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\DeleteUserResponse';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->deleteSnapTradeUserRequest($user_id, $contentType);
     ...
     */
    public function listSnapTradeUsersWithHttpInfo(string $contentType = self::contentTypes['listSnapTradeUsers'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listSnapTradeUsersAsyncWithHttpInfo(string $contentType = self::contentTypes['listSnapTradeUsers'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = 'string[]';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->listSnapTradeUsersRequest($contentType);
     ...
     */
    public function loginSnapTradeUserWithHttpInfo($user_id, $user_secret, $snap_trade_login_user_request_body = null, string $contentType = self::contentTypes['loginSnapTradeUser'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function loginSnapTradeUserAsyncWithHttpInfo($user_id, $user_secret, $snap_trade_login_user_request_body = null, string $contentType = self::contentTypes['loginSnapTradeUser'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\AuthenticationLoginSnapTradeUser200Response';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->loginSnapTradeUserRequest($user_id, $user_secret, $snap_trade_login_user_request_body, $contentType);
     ...
     */
    public function registerSnapTradeUserWithHttpInfo($snap_trade_register_user_request_body, string $contentType = self::contentTypes['registerSnapTradeUser'][0], \SnapTrade\RequestOptions $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function registerSnapTradeUserAsyncWithHttpInfo($snap_trade_register_user_request_body, string $contentType = self::contentTypes['registerSnapTradeUser'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\UserIDandSecret';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->registerSnapTradeUserRequest($snap_trade_register_user_request_body, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resetSnapTradeUserSecretAsyncWithHttpInfo($user_i_dand_secret, string $contentType = self::contentTypes['resetSnapTradeUserSecret'][0], $requestOptions = null)
    {
        if ($requestOptions == null) $requestOptions = new \SnapTrade\RequestOptions();
        $returnType = '\SnapTrade\Model\UserIDandSecret';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->resetSnapTradeUserSecretRequest($user_i_dand_secret, $contentType);
