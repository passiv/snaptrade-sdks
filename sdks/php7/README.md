...
[![Packagist](https://img.shields.io/badge/Packagist-v3.0.20-blue)](https://packagist.org/packages/konfig/snaptrade-php-7-sdk)
...
```json
{
  ...
  "require": {
    "konfig/snaptrade-php-7-sdk": "3.0.20"
  }
}
```
...
```php
$result = $snaptrade->connections->listConnectionAccounts(
    "87b24961-b51e-4db8-9226-f198f6518a89", 
    "snaptrade-user-123", 
    "adf2aa34-8219-40f7-a6b3-60156985cc61"
);
