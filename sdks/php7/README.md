...
[![Packagist](https://img.shields.io/badge/Packagist-v3.0.5-blue)](https://packagist.org/packages/konfig/snaptrade-php-7-sdk)
...
```json
{
  ...
  "require": {
    "konfig/snaptrade-php-7-sdk": "3.0.5"
  }
}
```
...
```php
$result = $snaptrade->accountInformation->getUserAumPercentile(
    "snaptrade-user-123", 
    "adf2aa34-8219-40f7-a6b3-60156985cc61"
);
```
...
[**UserAumPercentileResponse**](./lib/Model/UserAumPercentileResponse.php)
