...
{
    Debug.Print("Exception when calling ExperimentalEndpointsApi.GetAllAccountPositionsWithHttpInfo: " + e.Message);
...
{
    Debug.Print("Exception when calling ExperimentalEndpointsApi.SyncBrokerageAuthorizationTransactionsWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
