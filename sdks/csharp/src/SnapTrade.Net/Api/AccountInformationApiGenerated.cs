...
namespace SnapTrade.Net.Api
{
    ...
    public interface IAccountInformationApiSync : IApiAccessor
    {
        ...
        /// <param name="accountId"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AllAccountPositionsResponse</returns>
        AllAccountPositionsResponse GetAllAccountPositions(string userId, string userSecret, string accountId, int operationIndex = 0);
        ...
        /// <param name="accountId"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AllAccountPositionsResponse</returns>
        ApiResponse<AllAccountPositionsResponse> GetAllAccountPositionsWithHttpInfo(string userId, string userSecret, string accountId, int operationIndex = 0);
        /// <summary>
        ...
        RateOfReturnResponse GetUserAccountReturnRates(string userId, string userSecret, string accountId, string timeframes = default(string), int operationIndex = 0);
        ...
        ApiResponse<RateOfReturnResponse> GetUserAccountReturnRatesWithHttpInfo(string userId, string userSecret, string accountId, string timeframes = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="userSecret"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>UserAumPercentileResponse</returns>
        UserAumPercentileResponse GetUserAumPercentile(string userId, string userSecret, int operationIndex = 0);
        ...
        /// <param name="userSecret"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserAumPercentileResponse</returns>
        ApiResponse<UserAumPercentileResponse> GetUserAumPercentileWithHttpInfo(string userId, string userSecret, int operationIndex = 0);
        /// <summary>
    ...
    public interface IAccountInformationApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AllAccountPositionsResponse</returns>
        System.Threading.Tasks.Task<AllAccountPositionsResponse> GetAllAccountPositionsAsync(string userId, string userSecret, string accountId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AllAccountPositionsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<AllAccountPositionsResponse>> GetAllAccountPositionsWithHttpInfoAsync(string userId, string userSecret, string accountId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List account balances
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<RateOfReturnResponse> GetUserAccountReturnRatesAsync(string userId, string userSecret, string accountId, string timeframes = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<RateOfReturnResponse>> GetUserAccountReturnRatesWithHttpInfoAsync(string userId, string userSecret, string accountId, string timeframes = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get the user&#39;s AUM percentile
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UserAumPercentileResponse</returns>
        System.Threading.Tasks.Task<UserAumPercentileResponse> GetUserAumPercentileAsync(string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserAumPercentileResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<UserAumPercentileResponse>> GetUserAumPercentileWithHttpInfoAsync(string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List account holdings
        /// </summary>
        /// <remarks>
    ...
    public partial class AccountInformationApiGenerated : IAccountInformationApi
    {
        ...
        /// <summary>
        /// List account activities This endpoint is not deprecated and has no planned sunset. Responses to requests using the legacy &#x60;/api/v1&#x60; path prefix include &#x60;Deprecation: @1781222400&#x60; (June 12, 2026); that header applies only to the path prefix. Use the canonical root path &#x60;/accounts/{accountId}/activities&#x60;.  Returns all historical transactions for the specified account.  This endpoint is paginated with a default page size of 1000. The endpoint will return a maximum of 1000 transactions per request. See the query parameters for pagination options.  Transaction are returned in reverse chronological order, using the &#x60;trade_date&#x60; field.  This endpoint returns Daily data. Daily data is cached and refreshed once a day. Exact refresh timing may vary by brokerage.  If the connection has become disabled, it can no longer access the latest data from the brokerage, but will continue to return the last available cached state. Please see [this guide](/docs/fix-broken-connections) on how to fix a disabled connection. 
        /// </summary>
        /// <exception cref="SnapTrade.Net.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accountId"></param>
        /// <param name="userId"></param>
        ...
        public SnapTrade.Net.Client.ApiResponse<AccountValueHistoryResponse> GetAccountBalanceHistoryWithHttpInfo(string userId, string userSecret, string accountId, int operationIndex = 0)
        {
            ...
            if (userId == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'userId' when calling AccountInformationApi->GetAccountBalanceHistory");
            }

            // verify the required parameter 'userSecret' is set
            if (userSecret == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'userSecret' when calling AccountInformationApi->GetAccountBalanceHistory");
            }

            // verify the required parameter 'accountId' is set
            if (accountId == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'accountId' when calling AccountInformationApi->GetAccountBalanceHistory");
            }
            ...
            localVarRequestOptions.Operation = "AccountInformationApi.GetAccountBalanceHistory";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>AllAccountPositionsResponse</returns>
        public AllAccountPositionsResponse GetAllAccountPositions(string userId, string userSecret, string accountId, int operationIndex = 0)
        {
            SnapTrade.Net.Client.ApiResponse<AllAccountPositionsResponse> localVarResponse = GetAllAccountPositionsWithHttpInfo(userId, userSecret, accountId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of AllAccountPositionsResponse</returns>
        public SnapTrade.Net.Client.ApiResponse<AllAccountPositionsResponse> GetAllAccountPositionsWithHttpInfo(string userId, string userSecret, string accountId, int operationIndex = 0)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'userId' when calling AccountInformationApi->GetAllAccountPositions");
            }

            // verify the required parameter 'userSecret' is set
            if (userSecret == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'userSecret' when calling AccountInformationApi->GetAllAccountPositions");
            }

            // verify the required parameter 'accountId' is set
            if (accountId == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'accountId' when calling AccountInformationApi->GetAllAccountPositions");
            }
            ...
            localVarRequestOptions.Operation = "AccountInformationApi.GetAllAccountPositions";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<AllAccountPositionsResponse>("/accounts/{accountId}/positions/all", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetAllAccountPositions", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AllAccountPositionsResponse</returns>
        public async System.Threading.Tasks.Task<AllAccountPositionsResponse> GetAllAccountPositionsAsync(string userId, string userSecret, string accountId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            SnapTrade.Net.Client.ApiResponse<AllAccountPositionsResponse> localVarResponse = await GetAllAccountPositionsWithHttpInfoAsync(userId, userSecret, accountId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AllAccountPositionsResponse)</returns>
        public virtual async System.Threading.Tasks.Task<SnapTrade.Net.Client.ApiResponse<AllAccountPositionsResponse>> GetAllAccountPositionsWithHttpInfoAsync(string userId, string userSecret, string accountId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AllAccountPositionsResponse>("/accounts/{accountId}/positions/all", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// List account orders Returns a list of recent orders in the specified account.  Check your API key on the [Customer Dashboard billing page](https://dashboard.snaptrade.com/settings/billing) to see if you have real-time data access:   - If you do, this endpoint returns real-time data.   - If you don&#39;t, Daily data is cached and refreshed once a day. Exact refresh timing may vary by brokerage. If you need real-time, use the [manual refresh](/reference/Connections/Connections_refreshBrokerageAuthorization) endpoint.  If the connection has become disabled, it can no longer access the latest data from the brokerage, but will continue to return the last available cached state. Please see [this guide](/docs/fix-broken-connections) on how to fix a disabled connection. 
        /// </summary>
        /// <exception cref="SnapTrade.Net.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId"></param>
        /// <param name="userSecret"></param>
        ...
        /// <summary>
        /// List account recent orders (last 24 hours only) A lightweight endpoint that returns the latest page of orders placed in the last 24 hours in the specified account. For most brokerages, the default page size is 100 meaning the endpoint will return a max of 100 orders. This endpoint is realtime and can be used to quickly check if account state has recently changed due to an execution, or check status of recently placed orders Differs from /orders in that it is always realtime, and only checks the last 24 hours By default only returns executed orders, but that can be changed by setting *only_executed* to false 
        /// </summary>
        /// <exception cref="SnapTrade.Net.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId"></param>
        /// <param name="userSecret"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>RateOfReturnResponse</returns>
        public RateOfReturnResponse GetUserAccountReturnRates(string userId, string userSecret, string accountId, string timeframes = default(string), int operationIndex = 0)
        {
            SnapTrade.Net.Client.ApiResponse<RateOfReturnResponse> localVarResponse = GetUserAccountReturnRatesWithHttpInfo(userId, userSecret, accountId, timeframes);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RateOfReturnResponse</returns>
        public SnapTrade.Net.Client.ApiResponse<RateOfReturnResponse> GetUserAccountReturnRatesWithHttpInfo(string userId, string userSecret, string accountId, string timeframes = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of RateOfReturnResponse</returns>
        public async System.Threading.Tasks.Task<RateOfReturnResponse> GetUserAccountReturnRatesAsync(string userId, string userSecret, string accountId, string timeframes = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            SnapTrade.Net.Client.ApiResponse<RateOfReturnResponse> localVarResponse = await GetUserAccountReturnRatesWithHttpInfoAsync(userId, userSecret, accountId, timeframes, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <summary>
        /// Get the user&#39;s AUM percentile Returns where the user&#39;s total assets sit within the distribution of a cohort of comparable users, as a coarse bucket plus an integer percentile.  The cohort is scoped to your own book: a user is only ever compared against your other users, never across SnapTrade customers. (Users on personal-use keys are the exception — they are compared against all other personal-use users, since a personal key has a single user and cannot form a distribution of its own.) The distribution is recomputed monthly, and &#x60;as_of&#x60; reports which month&#39;s distribution the placement came from.  &#x60;data&#x60; is &#x60;null&#x60; — a 200, not an error — when SnapTrade declines to place the user. That happens when the cohort is too small to publish a distribution, or when the user&#39;s own holdings are incomplete or stale (for example they hold a disabled connection). A placement computed from a partial view of a user&#39;s assets would understate them, so none is returned. 
        /// </summary>
        /// <exception cref="SnapTrade.Net.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId"></param>
        /// <param name="userSecret"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>UserAumPercentileResponse</returns>
        public UserAumPercentileResponse GetUserAumPercentile(string userId, string userSecret, int operationIndex = 0)
        {
            SnapTrade.Net.Client.ApiResponse<UserAumPercentileResponse> localVarResponse = GetUserAumPercentileWithHttpInfo(userId, userSecret);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserAumPercentileResponse</returns>
        public SnapTrade.Net.Client.ApiResponse<UserAumPercentileResponse> GetUserAumPercentileWithHttpInfo(string userId, string userSecret, int operationIndex = 0)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'userId' when calling AccountInformationApi->GetUserAumPercentile");
            }

            // verify the required parameter 'userSecret' is set
            if (userSecret == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'userSecret' when calling AccountInformationApi->GetUserAumPercentile");
            }
            ...
            localVarRequestOptions.Operation = "AccountInformationApi.GetUserAumPercentile";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<UserAumPercentileResponse>("/aumPercentile", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetUserAumPercentile", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UserAumPercentileResponse</returns>
        public async System.Threading.Tasks.Task<UserAumPercentileResponse> GetUserAumPercentileAsync(string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            SnapTrade.Net.Client.ApiResponse<UserAumPercentileResponse> localVarResponse = await GetUserAumPercentileWithHttpInfoAsync(userId, userSecret, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserAumPercentileResponse)</returns>
        public virtual async System.Threading.Tasks.Task<SnapTrade.Net.Client.ApiResponse<UserAumPercentileResponse>> GetUserAumPercentileWithHttpInfoAsync(string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<UserAumPercentileResponse>("/aumPercentile", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// List account holdings **Deprecated.** Use the finer-grained account data endpoints instead: [balances](/reference/Account%20Information/AccountInformation_getUserAccountBalance), [positions](/reference/Account%20Information/AccountInformation_getAllAccountPositions), and [orders](/reference/Account%20Information/AccountInformation_getUserAccountOrders).  This endpoint will return HTTP 410 Gone for all customers that sign up after May 11, 2026.  Returns a list of balances, positions, and recent orders for the specified account.  Check your API key on the [Customer Dashboard billing page](https://dashboard.snaptrade.com/settings/billing) to see if you have real-time data access:   - If you do, this endpoint returns real-time data.   - If you don&#39;t, Daily data is cached and refreshed once a day. Exact refresh timing may vary by brokerage. If you need real-time, use the [manual refresh](/reference/Connections/Connections_refreshBrokerageAuthorization) endpoint.  If the connection has become disabled, it can no longer access the latest data from the brokerage, but will continue to return the last available cached state. Please see [this guide](/docs/fix-broken-connections) on how to fix a disabled connection. 
        /// </summary>
        /// <exception cref="SnapTrade.Net.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="accountId"></param>
        /// <param name="userId"></param>
        ...
        /// <summary>
        /// List accounts Returns all brokerage accounts across all connections known to SnapTrade for the authenticated user.  This endpoint returns Daily data regardless of the customer&#39;s plan. Daily data is cached and refreshed once a day, which makes this endpoint fast and well-suited to listing accounts across all of a user&#39;s connections in a single call. Exact refresh timing may vary by brokerage. To get real-time data on Pay as you Go / Real-time, use the [list accounts for a connection endpoint](/reference/Connections/Connections_listBrokerageAuthorizationAccounts). Customers on Pay as you Go / Daily can force a refresh with the [manual refresh endpoint](/reference/Connections/Connections_refreshBrokerageAuthorization). 
        /// </summary>
        /// <exception cref="SnapTrade.Net.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId"></param>
        /// <param name="userSecret"></param>
