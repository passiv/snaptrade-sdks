...
namespace SnapTrade.Net.Api
{
    ...
    public interface IConnectionsApiSync : IApiAccessor
    {
        ...
        /// <returns>DeleteConnectionConfirmation</returns>
        DeleteConnectionConfirmation DeleteConnection(string connectionId, string userId, string userSecret, int operationIndex = 0);
        ...
        /// <param name="userSecret"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeleteConnectionConfirmation</returns>
        ApiResponse<DeleteConnectionConfirmation> DeleteConnectionWithHttpInfo(string connectionId, string userId, string userSecret, int operationIndex = 0);
        /// <summary>
        ...
        List<Account> ListBrokerageAuthorizationAccounts(string authorizationId, string userId, string userSecret, int operationIndex = 0);
        ...
        ApiResponse<List<Account>> ListBrokerageAuthorizationAccountsWithHttpInfo(string authorizationId, string userId, string userSecret, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="userSecret"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ConnectionAccountsResponse</returns>
        ConnectionAccountsResponse ListConnectionAccounts(string connectionId, string userId, string userSecret, int operationIndex = 0);
        ...
        /// <param name="userSecret"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ConnectionAccountsResponse</returns>
        ApiResponse<ConnectionAccountsResponse> ListConnectionAccountsWithHttpInfo(string connectionId, string userId, string userSecret, int operationIndex = 0);
        /// <summary>
    ...
    public interface IConnectionsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of DeleteConnectionConfirmation</returns>
        System.Threading.Tasks.Task<DeleteConnectionConfirmation> DeleteConnectionAsync(string connectionId, string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeleteConnectionConfirmation)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeleteConnectionConfirmation>> DeleteConnectionWithHttpInfoAsync(string connectionId, string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get connection detail
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<Account>> ListBrokerageAuthorizationAccountsAsync(string authorizationId, string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Account>>> ListBrokerageAuthorizationAccountsWithHttpInfoAsync(string authorizationId, string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List all connections
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ConnectionAccountsResponse</returns>
        System.Threading.Tasks.Task<ConnectionAccountsResponse> ListConnectionAccountsAsync(string connectionId, string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ConnectionAccountsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<ConnectionAccountsResponse>> ListConnectionAccountsWithHttpInfoAsync(string connectionId, string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Refresh holdings for a connection
        /// </summary>
        /// <remarks>
    ...
    public partial class ConnectionsApiGenerated : IConnectionsApi
    {
        ...
        /// <summary>
        /// Delete connection Deletes the SnapTrade connection specified by the ID. This will also remove the accounts and holdings data associated with the connection from SnapTrade. This action is irreversible. This endpoint is asynchronous, a 200 response indicates that a task has been queued to delete the connection. Listen for the [&#x60;CONNECTION_DELETED&#x60; webhook](https://docs.snaptrade.com/docs/webhooks#webhooks-connection_deleted) webhook to know when the deletion has been completed and the data has been removed.
        /// </summary>
        /// <exception cref="SnapTrade.Net.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="connectionId"></param>
        /// <param name="userId"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DeleteConnectionConfirmation</returns>
        public DeleteConnectionConfirmation DeleteConnection(string connectionId, string userId, string userSecret, int operationIndex = 0)
        {
            SnapTrade.Net.Client.ApiResponse<DeleteConnectionConfirmation> localVarResponse = DeleteConnectionWithHttpInfo(connectionId, userId, userSecret);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DeleteConnectionConfirmation</returns>
        public SnapTrade.Net.Client.ApiResponse<DeleteConnectionConfirmation> DeleteConnectionWithHttpInfo(string connectionId, string userId, string userSecret, int operationIndex = 0)
        {
            // verify the required parameter 'connectionId' is set
            if (connectionId == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'connectionId' when calling ConnectionsApi->DeleteConnection");
            }

            // verify the required parameter 'userId' is set
            if (userId == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'userId' when calling ConnectionsApi->DeleteConnection");
            }

            // verify the required parameter 'userSecret' is set
            if (userSecret == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'userSecret' when calling ConnectionsApi->DeleteConnection");
            }
            ...
            var localVarResponse = this.Client.Delete<DeleteConnectionConfirmation>("/connection/{connectionId}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeleteConnectionConfirmation</returns>
        public async System.Threading.Tasks.Task<DeleteConnectionConfirmation> DeleteConnectionAsync(string connectionId, string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            SnapTrade.Net.Client.ApiResponse<DeleteConnectionConfirmation> localVarResponse = await DeleteConnectionWithHttpInfoAsync(connectionId, userId, userSecret, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeleteConnectionConfirmation)</returns>
        public virtual async System.Threading.Tasks.Task<SnapTrade.Net.Client.ApiResponse<DeleteConnectionConfirmation>> DeleteConnectionWithHttpInfoAsync(string connectionId, string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'connectionId' is set
            if (connectionId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<DeleteConnectionConfirmation>("/connection/{connectionId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// List accounts for a connection Returns all brokerage accounts that belong to the specified connection for the authenticated user.  On Pay as you Go / Real-time, this endpoint refreshes each account&#39;s opening date, funding date, and total value live from the brokerage on each call.  On Pay as you Go / Daily, this endpoint returns Daily data. Daily data is cached and refreshed once a day. Exact refresh timing may vary by brokerage. To force a refresh, use the [manual refresh endpoint](/reference/Connections/Connections_refreshBrokerageAuthorization).  Check your API key on the [Customer Dashboard billing page](https://dashboard.snaptrade.com/settings/billing) to see whether your plan includes real-time data. 
        /// </summary>
        /// <exception cref="SnapTrade.Net.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorizationId"></param>
        /// <param name="userId"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;Account&gt;</returns>
        public List<Account> ListBrokerageAuthorizationAccounts(string authorizationId, string userId, string userSecret, int operationIndex = 0)
        {
            SnapTrade.Net.Client.ApiResponse<List<Account>> localVarResponse = ListBrokerageAuthorizationAccountsWithHttpInfo(authorizationId, userId, userSecret);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;Account&gt;</returns>
        public SnapTrade.Net.Client.ApiResponse<List<Account>> ListBrokerageAuthorizationAccountsWithHttpInfo(string authorizationId, string userId, string userSecret, int operationIndex = 0)
        {
            // verify the required parameter 'authorizationId' is set
            if (authorizationId == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'authorizationId' when calling ConnectionsApi->ListBrokerageAuthorizationAccounts");
            }

            // verify the required parameter 'userId' is set
            if (userId == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'userId' when calling ConnectionsApi->ListBrokerageAuthorizationAccounts");
            }

            // verify the required parameter 'userSecret' is set
            if (userSecret == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'userSecret' when calling ConnectionsApi->ListBrokerageAuthorizationAccounts");
            }
            ...
            localVarRequestOptions.Operation = "ConnectionsApi.ListBrokerageAuthorizationAccounts";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<Account>>("/authorizations/{authorizationId}/accounts", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ListBrokerageAuthorizationAccounts", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;Account&gt;</returns>
        public async System.Threading.Tasks.Task<List<Account>> ListBrokerageAuthorizationAccountsAsync(string authorizationId, string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            SnapTrade.Net.Client.ApiResponse<List<Account>> localVarResponse = await ListBrokerageAuthorizationAccountsWithHttpInfoAsync(authorizationId, userId, userSecret, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Account&gt;)</returns>
        public virtual async System.Threading.Tasks.Task<SnapTrade.Net.Client.ApiResponse<List<Account>>> ListBrokerageAuthorizationAccountsWithHttpInfoAsync(string authorizationId, string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'authorizationId' is set
            if (authorizationId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<Account>>("/authorizations/{authorizationId}/accounts", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// List accounts Returns all accounts that belong to the specified connection for the authenticated user.  The &#x60;results&#x60; list can contain multiple account kinds in the same response, including investment, deposit, and line of credit accounts. Use the &#x60;kind&#x60; discriminator to determine the shape for each account.  On Pay as you Go / Real-time, this endpoint refreshes each account&#39;s opening date and total net value (&#x60;net_value&#x60;) live from the institution on each call, along with funding date for &#x60;investment&#x60; accounts.  On Pay as you Go / Daily, this endpoint returns Daily data. Daily data is cached and refreshed once a day. Exact refresh timing may vary by institution. To force a refresh, use the [manual refresh endpoint](/reference/Connections/Connections_refreshBrokerageAuthorization).  Check your API key on the [Customer Dashboard billing page](https://dashboard.snaptrade.com/settings/billing) to see whether your plan includes real-time data. 
        /// </summary>
        /// <exception cref="SnapTrade.Net.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="connectionId"></param>
        /// <param name="userId"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ConnectionAccountsResponse</returns>
        public ConnectionAccountsResponse ListConnectionAccounts(string connectionId, string userId, string userSecret, int operationIndex = 0)
        {
            SnapTrade.Net.Client.ApiResponse<ConnectionAccountsResponse> localVarResponse = ListConnectionAccountsWithHttpInfo(connectionId, userId, userSecret);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ConnectionAccountsResponse</returns>
        public SnapTrade.Net.Client.ApiResponse<ConnectionAccountsResponse> ListConnectionAccountsWithHttpInfo(string connectionId, string userId, string userSecret, int operationIndex = 0)
        {
            // verify the required parameter 'connectionId' is set
            if (connectionId == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'connectionId' when calling ConnectionsApi->ListConnectionAccounts");
            }

            // verify the required parameter 'userId' is set
            if (userId == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'userId' when calling ConnectionsApi->ListConnectionAccounts");
            }

            // verify the required parameter 'userSecret' is set
            if (userSecret == null)
            {
                throw new SnapTrade.Net.Client.ApiException(400, "Missing required parameter 'userSecret' when calling ConnectionsApi->ListConnectionAccounts");
            }
            ...
            localVarRequestOptions.Operation = "ConnectionsApi.ListConnectionAccounts";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ConnectionAccountsResponse>("/connections/{connectionId}/accounts", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ConnectionAccountsResponse</returns>
        public async System.Threading.Tasks.Task<ConnectionAccountsResponse> ListConnectionAccountsAsync(string connectionId, string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            SnapTrade.Net.Client.ApiResponse<ConnectionAccountsResponse> localVarResponse = await ListConnectionAccountsWithHttpInfoAsync(connectionId, userId, userSecret, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ConnectionAccountsResponse)</returns>
        public virtual async System.Threading.Tasks.Task<SnapTrade.Net.Client.ApiResponse<ConnectionAccountsResponse>> ListConnectionAccountsWithHttpInfoAsync(string connectionId, string userId, string userSecret, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'connectionId' is set
            if (connectionId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ConnectionAccountsResponse>("/connections/{connectionId}/accounts", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
