...
namespace SnapTrade.Net.Api
{
    ...
    public interface IPortfolioManagementApiSync : IApiAccessor
    {
        ...
        /// <param name="portfolioGroupId">The ID of the PortfolioGroup under which to create the target asset.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;PortfolioGroupPosition&gt;</returns>
        List<PortfolioGroupPosition> GetPortfolioPositions(Guid portfolioGroupId, int operationIndex = 0);
        ...
        /// <param name="portfolioGroupId">The ID of the PortfolioGroup under which to create the target asset.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;PortfolioGroupPosition&gt;</returns>
        ApiResponse<List<PortfolioGroupPosition>> GetPortfolioPositionsWithHttpInfo(Guid portfolioGroupId, int operationIndex = 0);
        /// <summary>
    ...
    public interface IPortfolioManagementApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;PortfolioGroupPosition&gt;</returns>
        System.Threading.Tasks.Task<List<PortfolioGroupPosition>> GetPortfolioPositionsAsync(Guid portfolioGroupId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;PortfolioGroupPosition&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<PortfolioGroupPosition>>> GetPortfolioPositionsWithHttpInfoAsync(Guid portfolioGroupId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get portfolio group settings
        /// </summary>
        /// <remarks>
    ...
    public partial class PortfolioManagementApi : IPortfolioManagementApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;PortfolioGroupPosition&gt;</returns>
        public List<PortfolioGroupPosition> GetPortfolioPositions(Guid portfolioGroupId, int operationIndex = 0)
        {
            SnapTrade.Net.Client.ApiResponse<List<PortfolioGroupPosition>> localVarResponse = GetPortfolioPositionsWithHttpInfo(portfolioGroupId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;PortfolioGroupPosition&gt;</returns>
        public SnapTrade.Net.Client.ApiResponse<List<PortfolioGroupPosition>> GetPortfolioPositionsWithHttpInfo(Guid portfolioGroupId, int operationIndex = 0)
        {
            SnapTrade.Net.Client.RequestOptions localVarRequestOptions = new SnapTrade.Net.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "PortfolioManagementApi.GetPortfolioPositions";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<PortfolioGroupPosition>>("/portfolioGroups/{portfolioGroupId}/positions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetPortfolioPositions", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;PortfolioGroupPosition&gt;</returns>
        public async System.Threading.Tasks.Task<List<PortfolioGroupPosition>> GetPortfolioPositionsAsync(Guid portfolioGroupId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            SnapTrade.Net.Client.ApiResponse<List<PortfolioGroupPosition>> localVarResponse = await GetPortfolioPositionsWithHttpInfoAsync(portfolioGroupId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;PortfolioGroupPosition&gt;)</returns>
        public async System.Threading.Tasks.Task<SnapTrade.Net.Client.ApiResponse<List<PortfolioGroupPosition>>> GetPortfolioPositionsWithHttpInfoAsync(Guid portfolioGroupId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<PortfolioGroupPosition>>("/portfolioGroups/{portfolioGroupId}/positions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
