...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Balance_currency")]
    public partial class BalanceCurrency : IEquatable<BalanceCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BalanceCurrency" /> class.
        /// </summary>
        ...
        public BalanceCurrency(string id = default(string), string code = default(string), string name = default(string))
        {
            this.Id = id;
            this.Code = code;
            this.Name = name;
        ...
        {
            return this.Equals(input as BalanceCurrency);
        }

        /// <summary>
        /// Returns true if BalanceCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of BalanceCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BalanceCurrency input)
        {
            if (input == null)
            {
                return false;
