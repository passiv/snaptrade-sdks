...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ModelPortfolioSecurity")]
    public partial class ModelPortfolioSecurity : IEquatable<ModelPortfolioSecurity>, IValidatableObject
    {
        /// <summary>
        ...
        public ModelPortfolioSecurity(UniversalSymbol symbol = default(UniversalSymbol), int percent = default(int)) : base()
        {
            this.Symbol = symbol;
        ...
        {
            return this.Equals(input as ModelPortfolioSecurity);
        }

        /// <summary>
        /// Returns true if ModelPortfolioSecurity instances are equal
        /// </summary>
        /// <param name="input">Instance of ModelPortfolioSecurity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModelPortfolioSecurity input)
        {
            if (input == null)
            {
                return false;
