...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SymbolNullable")]
    public partial class SymbolNullable : IEquatable<SymbolNullable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SymbolNullable" /> class.
        /// </summary>
        ...
        public SymbolNullable(string id = default(string), string symbol = default(string), string rawSymbol = default(string), string description = default(string), SymbolCurrency currency = default(SymbolCurrency), SymbolExchange exchange = default(SymbolExchange), SecurityType type = default(SecurityType), string figiCode = default(string), FigiInstrumentNullable figiInstrument = default(FigiInstrumentNullable)) : base()
        {
            this.Id = id;
            this.Symbol = symbol;
        ...
        {
            return this.Equals(input as SymbolNullable);
        }

        /// <summary>
        /// Returns true if SymbolNullable instances are equal
        /// </summary>
        /// <param name="input">Instance of SymbolNullable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SymbolNullable input)
        {
            if (input == null)
            {
                return false;
