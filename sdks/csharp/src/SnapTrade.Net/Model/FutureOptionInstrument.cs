...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FutureOptionInstrument")]
    public partial class FutureOptionInstrument : IEquatable<FutureOptionInstrument>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum FutureOption for value: future_option
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FutureOptionInstrument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FutureOptionInstrument()
        {
        ...
        /// <param name="id">Unique identifier for the future option instrument. (required).</param>
        /// <param name="symbol">Display symbol for the future option contract. (required).</param>
        ...
        /// <param name="multiplier">Notional multiplier for the option contract..</param>
        ...
        public FutureOptionInstrument(KindEnum kind = default(KindEnum), string id = default(string), string symbol = default(string), OptionTypeEnum optionType = default(OptionTypeEnum), decimal strikePrice = default(decimal), DateTime expirationDate = default(DateTime), decimal? multiplier = default(decimal?), string description = default(string), string currency = default(string), string exchange = default(string), FutureInstrument underlying = default(FutureInstrument)) : base()
        {
            this.Kind = kind;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for FutureOptionInstrument and cannot be null");
            }
            this.Id = id;
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for FutureOptionInstrument and cannot be null");
            }
            this.Symbol = symbol;
            ...
            if (underlying == null)
            {
                throw new ArgumentNullException("underlying is a required property for FutureOptionInstrument and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Unique identifier for the future option instrument.</value>
        ...
        /// </summary>
        /// <value>Display symbol for the future option contract.</value>
        ...
        /// </summary>
        /// <value>Notional multiplier for the option contract.</value>
        ...
        public FutureInstrument Underlying { get; set; }
        ...
        {
            return this.Equals(input as FutureOptionInstrument);
        }

        /// <summary>
        /// Returns true if FutureOptionInstrument instances are equal
        /// </summary>
        /// <param name="input">Instance of FutureOptionInstrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FutureOptionInstrument input)
        {
            if (input == null)
            {
                return false;
