...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "400FailedRequestResponse")]
    public partial class Model400FailedRequestResponse : IEquatable<Model400FailedRequestResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public Model400FailedRequestResponse(Object defaultDetail = default(Object), Object defaultCode = default(Object)) : base()
        {
        ...
        {
            return this.Equals(input as Model400FailedRequestResponse);
        }

        /// <summary>
        /// Returns true if Model400FailedRequestResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of Model400FailedRequestResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Model400FailedRequestResponse input)
        {
            if (input == null)
            {
                return false;
