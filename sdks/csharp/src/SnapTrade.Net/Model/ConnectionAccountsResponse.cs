...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConnectionAccountsResponse")]
    public partial class ConnectionAccountsResponse : IEquatable<ConnectionAccountsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectionAccountsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConnectionAccountsResponse()
        {
        ...
        /// Initializes a new instance of the <see cref="ConnectionAccountsResponse" /> class.
        /// </summary>
        /// <param name="results">Accounts returned for the request. (required).</param>
        public ConnectionAccountsResponse(List<ConnectionAccount> results = default(List<ConnectionAccount>)) : base()
        {
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new ArgumentNullException("results is a required property for ConnectionAccountsResponse and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Accounts returned for the request.</value>
        [DataMember(Name = "results", IsRequired = true, EmitDefaultValue = true)]
        public List<ConnectionAccount> Results { get; set; }
        ...
        {
            return this.Equals(input as ConnectionAccountsResponse);
        }

        /// <summary>
        /// Returns true if ConnectionAccountsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnectionAccountsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectionAccountsResponse input)
        {
            if (input == null)
            {
                return false;
