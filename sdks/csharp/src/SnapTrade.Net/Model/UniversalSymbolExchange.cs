...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UniversalSymbol_exchange")]
    public partial class UniversalSymbolExchange : IEquatable<UniversalSymbolExchange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UniversalSymbolExchange" /> class.
        /// </summary>
        ...
        public UniversalSymbolExchange(string id = default(string), string code = default(string), string micCode = default(string), string name = default(string), string timezone = default(string), string startTime = default(string), string closeTime = default(string), string suffix = default(string))
        {
            this.Id = id;
            this.Code = code;
        ...
        {
            return this.Equals(input as UniversalSymbolExchange);
        }

        /// <summary>
        /// Returns true if UniversalSymbolExchange instances are equal
        /// </summary>
        /// <param name="input">Instance of UniversalSymbolExchange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UniversalSymbolExchange input)
        {
            if (input == null)
            {
                return false;
