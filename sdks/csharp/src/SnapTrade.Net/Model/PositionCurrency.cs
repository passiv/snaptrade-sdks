...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Position_currency")]
    public partial class PositionCurrency : IEquatable<PositionCurrency>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PositionCurrency" /> class.
        /// </summary>
        ...
        public PositionCurrency(string id = default(string), string code = default(string), string name = default(string))
        {
            this.Id = id;
            this.Code = code;
            this.Name = name;
        ...
        {
            return this.Equals(input as PositionCurrency);
        }

        /// <summary>
        /// Returns true if PositionCurrency instances are equal
        /// </summary>
        /// <param name="input">Instance of PositionCurrency to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PositionCurrency input)
        {
            if (input == null)
            {
                return false;
