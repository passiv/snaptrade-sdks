...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StopLossNullable")]
    public partial class StopLossNullable : IEquatable<StopLossNullable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StopLossNullable" /> class.
        /// </summary>
        /// <param name="stopPrice">stopPrice.</param>
        /// <param name="limitPrice">limitPrice.</param>
        public StopLossNullable(string stopPrice = default(string), string limitPrice = default(string)) : base()
        {
        ...
        {
            return this.Equals(input as StopLossNullable);
        }

        /// <summary>
        /// Returns true if StopLossNullable instances are equal
        /// </summary>
        /// <param name="input">Instance of StopLossNullable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StopLossNullable input)
        {
            if (input == null)
            {
                return false;
