...
namespace SnapTrade.Net.Model
{
    ...
    public partial class Position : IEquatable<Position>, IValidatableObject
    {
        ...
        /// <param name="taxLots">List of tax lots for the given position. Disabled by default, only available on paid plans, enable this feature in the [Add-on page of the Customer Dashboard](https://dashboard.snaptrade.com/add-ons).</param>
        ...
        /// </summary>
        /// <value>List of tax lots for the given position. Disabled by default, only available on paid plans, enable this feature in the [Add-on page of the Customer Dashboard](https://dashboard.snaptrade.com/add-ons)</value>
