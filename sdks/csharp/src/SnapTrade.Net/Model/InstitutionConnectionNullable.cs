...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstitutionConnectionNullable")]
    public partial class InstitutionConnectionNullable : IEquatable<InstitutionConnectionNullable>, IValidatableObject
    {
        /// <summary>
        /// Defines Methods
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstitutionConnectionNullable" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstitutionConnectionNullable()
        {
        ...
        public InstitutionConnectionNullable(List<MethodsEnum> methods = default(List<MethodsEnum>), List<ScopesEnum> scopes = default(List<ScopesEnum>)) : base()
        {
            // to ensure "methods" is required (not null)
            if (methods == null)
            {
                throw new ArgumentNullException("methods is a required property for InstitutionConnectionNullable and cannot be null");
            }
            this.Methods = methods;
            // to ensure "scopes" is required (not null)
            if (scopes == null)
            {
                throw new ArgumentNullException("scopes is a required property for InstitutionConnectionNullable and cannot be null");
            }
            this.Scopes = scopes;
            this.AdditionalProperties = new Dictionary<string, object>();
        }
        ...
        public List<InstitutionConnectionNullable.MethodsEnum> Methods { get; set; }
        ...
        public List<InstitutionConnectionNullable.ScopesEnum> Scopes { get; set; }
        ...
        {
            return this.Equals(input as InstitutionConnectionNullable);
        }

        /// <summary>
        /// Returns true if InstitutionConnectionNullable instances are equal
        /// </summary>
        /// <param name="input">Instance of InstitutionConnectionNullable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstitutionConnectionNullable input)
        {
            if (input == null)
            {
                return false;
