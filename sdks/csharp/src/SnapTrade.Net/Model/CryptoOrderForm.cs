...
namespace SnapTrade.Net.Model
{
    ...
    /// CryptoOrderForm
    /// </summary>
    [DataContract(Name = "CryptoOrderForm")]
    public partial class CryptoOrderForm : IEquatable<CryptoOrderForm>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptoOrderForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CryptoOrderForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptoOrderForm" /> class.
        /// </summary>
        ...
        public CryptoOrderForm(CryptoTradingInstrument instrument = default(CryptoTradingInstrument), ActionStrict side = default(ActionStrict), TypeEnum type = default(TypeEnum), TimeInForceEnum timeInForce = default(TimeInForceEnum), decimal amount = default(decimal), decimal limitPrice = default(decimal), decimal stopPrice = default(decimal), bool postOnly = default(bool), DateTime expirationDate = default(DateTime))
        {
            // to ensure "instrument" is required (not null)
            if (instrument == null)
            {
                throw new ArgumentNullException("instrument is a required property for CryptoOrderForm and cannot be null");
            }
        ...
        public CryptoTradingInstrument Instrument { get; set; }
        ...
        {
            return this.Equals(input as CryptoOrderForm);
        }

        /// <summary>
        /// Returns true if CryptoOrderForm instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptoOrderForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptoOrderForm input)
        {
            if (input == null)
            {
                return false;
