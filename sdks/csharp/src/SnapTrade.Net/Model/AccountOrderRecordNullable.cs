...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountOrderRecordNullable")]
    public partial class AccountOrderRecordNullable : IEquatable<AccountOrderRecordNullable>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountOrderRecordNullable" /> class.
        /// </summary>
        ...
        public UniversalSymbolNullable QuoteUniversalSymbol { get; set; }
        ...
        {
            return this.Equals(input as AccountOrderRecordNullable);
        }

        /// <summary>
        /// Returns true if AccountOrderRecordNullable instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountOrderRecordNullable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountOrderRecordNullable input)
        {
            if (input == null)
            {
                return false;
