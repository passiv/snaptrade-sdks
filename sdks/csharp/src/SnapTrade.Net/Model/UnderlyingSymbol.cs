...
namespace SnapTrade.Net.Model
{
    ...
    public partial class UnderlyingSymbol : IEquatable<UnderlyingSymbol>, IValidatableObject
    {
        ...
        public UnderlyingSymbol(string id = default(string), string symbol = default(string), string description = default(string), Currency currency = default(Currency), USExchange exchange = default(USExchange), SecurityType type = default(SecurityType), List<Currency> currencies = default(List<Currency>), string figiCode = default(string)) : base()
        {
            this.Id = id;
            this.Symbol = symbol;
        ...
        {
            return this.Equals(input as UnderlyingSymbol);
        }

        /// <summary>
        /// Returns true if UnderlyingSymbol instances are equal
        /// </summary>
        /// <param name="input">Instance of UnderlyingSymbol to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnderlyingSymbol input)
        {
            if (input == null)
            {
                return false;
