...
namespace SnapTrade.Net.Model
{
    ...
    public partial class PastValue : Dictionary<String, Object>, IEquatable<PastValue>, IValidatableObject
    {
        ...
        public PastValue(string date = default(string), decimal value = default(decimal), string currency = default(string)) : base()
        {
            this.Date = date;
            this.Value = value;
        ...
        {
            return this.Equals(input as PastValue);
        }

        /// <summary>
        /// Returns true if PastValue instances are equal
        /// </summary>
        /// <param name="input">Instance of PastValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PastValue input)
        {
            if (input == null)
            {
                return false;
