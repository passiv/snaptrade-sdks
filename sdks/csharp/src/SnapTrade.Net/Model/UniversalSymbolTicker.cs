...
namespace SnapTrade.Net.Model
{
    ...
    public partial class UniversalSymbolTicker : IEquatable<UniversalSymbolTicker>, IValidatableObject
    {
        ...
        public UniversalSymbolTicker(string description = default(string), Guid id = default(Guid), string symbol = default(string), string rawSymbol = default(string), Currency currency = default(Currency), Exchange exchange = default(Exchange), SecurityType type = default(SecurityType), List<Currency> currencies = default(List<Currency>)) : base()
        {
