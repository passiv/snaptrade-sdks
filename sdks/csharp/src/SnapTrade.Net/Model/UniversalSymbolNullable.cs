...
namespace SnapTrade.Net.Model
{
    ...
    public partial class UniversalSymbolNullable : IEquatable<UniversalSymbolNullable>, IValidatableObject
    {
        ...
        public UniversalSymbolNullable(string id = default(string), string symbol = default(string), string rawSymbol = default(string), string description = default(string), Currency currency = default(Currency), Exchange exchange = default(Exchange), SecurityType type = default(SecurityType), List<Currency> currencies = default(List<Currency>), string figiCode = default(string), FigiInstrumentNullable figiInstrument = default(FigiInstrumentNullable)) : base()
        {
