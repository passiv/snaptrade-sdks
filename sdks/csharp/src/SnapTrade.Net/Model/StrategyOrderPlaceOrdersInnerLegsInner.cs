...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StrategyOrderPlace_orders_inner_legs_inner")]
    public partial class StrategyOrderPlaceOrdersInnerLegsInner : Dictionary<String, Object>, IEquatable<StrategyOrderPlaceOrdersInnerLegsInner>, IValidatableObject
    {
        /// <summary>
            /// Default constructor for <see cref="StrategyOrderPlaceOrdersInnerLegsInner" /> class.
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StrategyOrderPlaceOrdersInnerLegsInner" /> class.
        /// </summary>
        ...
        public StrategyOrderPlaceOrdersInnerLegsInner(int legId = default(int), string symbol = default(string), int symbolId = default(int), int legRatioQuantity = default(int), string side = default(string), int avgExecPrice = default(int), string lastExecPrice = default(string)) : base()
        {
            this.LegId = legId;
            this.Symbol = symbol;
        ...
        {
            return this.Equals(input as StrategyOrderPlaceOrdersInnerLegsInner);
        }

        /// <summary>
        /// Returns true if StrategyOrderPlaceOrdersInnerLegsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of StrategyOrderPlaceOrdersInnerLegsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StrategyOrderPlaceOrdersInnerLegsInner input)
        {
            if (input == null)
            {
                return false;
