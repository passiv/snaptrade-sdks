...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EtfInstrument")]
    public partial class EtfInstrument : IEquatable<EtfInstrument>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EtfInstrument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EtfInstrument()
        {
        ...
        public EtfInstrument(KindEnum kind = default(KindEnum), string id = default(string), string symbol = default(string), string rawSymbol = default(string), string description = default(string), string currency = default(string), string exchange = default(string), FigiInstrumentNullable figiInstrument = default(FigiInstrumentNullable)) : base()
        {
            this.Kind = kind;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for EtfInstrument and cannot be null");
            }
            this.Id = id;
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for EtfInstrument and cannot be null");
            }
            this.Symbol = symbol;
            // to ensure "rawSymbol" is required (not null)
            if (rawSymbol == null)
            {
                throw new ArgumentNullException("rawSymbol is a required property for EtfInstrument and cannot be null");
            }
        ...
        {
            return this.Equals(input as EtfInstrument);
        }

        /// <summary>
        /// Returns true if EtfInstrument instances are equal
        /// </summary>
        /// <param name="input">Instance of EtfInstrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EtfInstrument input)
        {
            if (input == null)
            {
                return false;
