...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CryptoInstrument")]
    public partial class CryptoInstrument : IEquatable<CryptoInstrument>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CryptoInstrument" /> class.
        /// </summary>
        ...
        public CryptoInstrument(KindEnum kind = default(KindEnum), string id = default(string), string symbol = default(string), string rawSymbol = default(string), string description = default(string), string currency = default(string), string exchange = default(string), FigiInstrumentNullable figiInstrument = default(FigiInstrumentNullable)) : base()
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CryptoInstrument and cannot be null");
            }
            this.Id = id;
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for CryptoInstrument and cannot be null");
            }
            this.Symbol = symbol;
            // to ensure "rawSymbol" is required (not null)
            if (rawSymbol == null)
            {
                throw new ArgumentNullException("rawSymbol is a required property for CryptoInstrument and cannot be null");
            }
        ...
        {
            return this.Equals(input as CryptoInstrument);
        }

        /// <summary>
        /// Returns true if CryptoInstrument instances are equal
        /// </summary>
        /// <param name="input">Instance of CryptoInstrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CryptoInstrument input)
        {
            if (input == null)
            {
                return false;
