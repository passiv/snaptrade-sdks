...
namespace SnapTrade.Net.Model
{
    ...
    public partial class UserIDandSecret : IEquatable<UserIDandSecret>, IValidatableObject
    {
        ...
        /// <param name="userSecret">SnapTrade User Secret. This is a randomly generated string and should be stored securely. If compromised, please rotate it via the [rotate user secret endpoint](/reference/Authentication/Authentication_resetSnapTradeUserSecret)..</param>
        ...
        /// </summary>
        /// <value>SnapTrade User Secret. This is a randomly generated string and should be stored securely. If compromised, please rotate it via the [rotate user secret endpoint](/reference/Authentication/Authentication_resetSnapTradeUserSecret).</value>
