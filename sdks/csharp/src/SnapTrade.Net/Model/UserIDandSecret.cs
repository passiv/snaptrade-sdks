...
namespace SnapTrade.Net.Model
{
    ...
    public partial class UserIDandSecret : IEquatable<UserIDandSecret>, IValidatableObject
    {
        ...
        /// <param name="userSecret">SnapTrade User Secret randomly generated by SnapTrade. This is privileged information and if compromised, should be rotated via the [rotate user secret endpoint](/reference/Authentication/Authentication_resetSnapTradeUserSecret).</param>
        public UserIDandSecret(string userId = default(string), string userSecret = default(string))
        {
            this.UserId = userId;
        ...
        /// </summary>
        /// <value>SnapTrade User Secret randomly generated by SnapTrade. This is privileged information and if compromised, should be rotated via the [rotate user secret endpoint](/reference/Authentication/Authentication_resetSnapTradeUserSecret)</value>
