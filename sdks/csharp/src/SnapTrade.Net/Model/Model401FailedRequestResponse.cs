...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "401FailedRequestResponse")]
    public partial class Model401FailedRequestResponse : Dictionary<String, Object>, IEquatable<Model401FailedRequestResponse>, IValidatableObject
    {
        /// <summary>
            /// Default constructor for <see cref="Model401FailedRequestResponse" /> class.
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Model401FailedRequestResponse" /> class.
        /// </summary>
        /// <param name="defaultDetail">defaultDetail.</param>
        /// <param name="defaultCode">defaultCode.</param>
        public Model401FailedRequestResponse(Object defaultDetail = default(Object), Object defaultCode = default(Object)) : base()
        {
        ...
        {
            return this.Equals(input as Model401FailedRequestResponse);
        }

        /// <summary>
        /// Returns true if Model401FailedRequestResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of Model401FailedRequestResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Model401FailedRequestResponse input)
        {
            if (input == null)
            {
                return false;
