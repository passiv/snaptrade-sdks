...
namespace SnapTrade.Net.Model
{
    ...
    public partial class LineOfCreditAccount : IEquatable<LineOfCreditAccount>, IValidatableObject
    {
        ...
        /// <param name="number">The account number assigned by the institution, masked to the last 4 characters (e.g. &#x60;****1881&#x60;). (required).</param>
        ...
        public LineOfCreditAccount(KindEnum kind = default(KindEnum), string id = default(string), string connectionId = default(string), string displayName = default(string), string number = default(string), string institutionAccountId = default(string), string institutionId = default(string), DateTime? openingDate = default(DateTime?), LineOfCreditAccountSyncStatus syncStatus = default(LineOfCreditAccountSyncStatus), string rawType = default(string), LineOfCreditAccountNetValue netValue = default(LineOfCreditAccountNetValue), LineOfCreditAccountCreditDetails creditDetails = default(LineOfCreditAccountCreditDetails)) : base()
        {
            this.Kind = kind;
            ...
            if (number == null)
            {
                throw new ArgumentNullException("number is a required property for LineOfCreditAccount and cannot be null");
            }
            this.Number = number;
        ...
        /// </summary>
        [DataMember(Name = "credit_details", EmitDefaultValue = true)]
        public LineOfCreditAccountCreditDetails CreditDetails { get; set; }
