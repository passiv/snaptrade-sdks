...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LineOfCreditAccount_available_credit")]
    public partial class LineOfCreditAccountAvailableCredit : IEquatable<LineOfCreditAccountAvailableCredit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LineOfCreditAccountAvailableCredit" /> class.
        /// </summary>
        /// <param name="amount">amount.</param>
        /// <param name="currency">currency.</param>
        public LineOfCreditAccountAvailableCredit(double? amount = default(double?), string currency = default(string)) : base()
        {
            this.Amount = amount;
        ...
        {
            return this.Equals(input as LineOfCreditAccountAvailableCredit);
        }

        /// <summary>
        /// Returns true if LineOfCreditAccountAvailableCredit instances are equal
        /// </summary>
        /// <param name="input">Instance of LineOfCreditAccountAvailableCredit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LineOfCreditAccountAvailableCredit input)
        {
            if (input == null)
            {
                return false;
