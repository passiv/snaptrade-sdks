...
namespace SnapTrade.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StockInstrument")]
    public partial class StockInstrument : IEquatable<StockInstrument>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StockInstrument" /> class.
        /// </summary>
        ...
        public StockInstrument(KindEnum kind = default(KindEnum), string id = default(string), string symbol = default(string), string rawSymbol = default(string), string description = default(string), string currency = default(string), string exchange = default(string), FigiInstrumentNullable figiInstrument = default(FigiInstrumentNullable)) : base()
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for StockInstrument and cannot be null");
            }
            this.Id = id;
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for StockInstrument and cannot be null");
            }
            this.Symbol = symbol;
            // to ensure "rawSymbol" is required (not null)
            if (rawSymbol == null)
            {
                throw new ArgumentNullException("rawSymbol is a required property for StockInstrument and cannot be null");
            }
        ...
        {
            return this.Equals(input as StockInstrument);
        }

        /// <summary>
        /// Returns true if StockInstrument instances are equal
        /// </summary>
        /// <param name="input">Instance of StockInstrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StockInstrument input)
        {
            if (input == null)
            {
                return false;
