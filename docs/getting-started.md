...
- **The userSecret to one of my SnapTrade users has been compromised. What should I do?**
  - The best thing to do in this case is to rotate the user secret using <https://docs.snaptrade.com/reference/Authentication/Authentication_resetSnapTradeUserSecret>.
