...
1. With your Free `API Key`, enter your `clientId` and `consumerKey` into the corresponding fields of [Get API Status](https://docs.snaptrade.com/reference/API%20Status/ApiStatus_check).
2. Press ‘Send’.
