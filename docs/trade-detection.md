...
> **Related docs**: [Best practices to serve real-time data](./realtime-data.md), [TRADE_DETECTION webhook](https://docs.snaptrade.com/docs/webhooks#webhooks-trade_detection)
